...
// Module declaration
#include "JEM_Analysis/SeExtEGCuts.h"
...
//------------------------------------------------------------
SeExtEGCuts::SeExtEGCuts(const std::string theName,
...
// Operations
//-------------------------------------------------------------------------
AppResult SeExtEGCuts::beginJob(AppEvent* aJob) {
...
AppResult SeExtEGCuts::beginRun(AppEvent* aRun) {
  return AppResult::OK;
}

AppResult SeExtEGCuts::event(AppEvent* anEvent) {
  ...
  if (!runRecord.is_valid()) {
    std::cout << "-- SeExtEGCuts - Error Accessing the RunHeader" << std::endl;
    anEvent->listObjects();
  ...
  if (ElectronColl::find(anEvent, theElectronColl)) {        
    ...
    std::cout << "-- SeExtEGCuts - Electrons not found" << std::endl;
    return AppResult::OK;
  }
  ...
  if (AlphaColl::find(anEvent, theAlphaColl)) {        
    ...
    std::cout << "-- SeExtEGCuts - Alphas not found" << std::endl;
    return AppResult::OK;
  }
  ...
  if (GammaClusterColl::find(anEvent, theGammaClusterColl)) {        
    ...
    std::cout << "-- SeExtEGCuts - Gamma Clusters not found" << std::endl;
    return AppResult::OK;
  }
  ...
  if (N3TrackSegmentColl::find(anEvent, theTrackColl)) {        
    ...
    std::cout << "-- SeExtEGCuts - Tracks not found" << std::endl;
    return AppResult::OK;        
  }
  ...
  if (CalibCaloHitColl::find(anEvent, theCaloHitColl)) {
    ...
    std::cout << "-- SeExtEGCuts - Calibrated calorimeter hits not found" << std::endl;
    return AppResult::OK;
  }
  ...
  if (N3CalorimeterHitColl::find(anEvent, theRawCaloHitColl)) {
    ...
    std::cout  << "-- SeExtEGCuts - Raw Calorimeter hits not found"  << std::endl;
    return AppResult::OK;
  }
  ...
  if (N3GeigerHitColl::find(anEvent, theRawGgHitColl)){
    ...
    std::cout << "-- SeExtEGCuts - Raw Geiger hits not found" << std::endl;
    return AppResult::OK;
  }
  ...
  if (TrueVertexColl::find(anEvent, theTrueVertexColl)){
    ...
    std::cout << "-- SeExtEGCuts - True Vertex info not found" << std::endl;
    return AppResult::OK;
  }
  ...
  if (!nemorHeader_ci.is_valid()) {
    std::cout << "-- SeExtEGCuts - Error Accessing the NemorHeader" << std::endl;
    anEvent->listObjects();
    return AppResult::ERROR;
  }
  ...
  // ================================================================================================
  // TRACKING CUTS - HITS IN FIRST & LAST TWO LAYERS, INTERSECTING FOIL, GOOD LENGTH & NEGATIVE CURV.
  // ================================================================================================
  ...
  // Store gamma entry point - 0 is Inner, 1 is Outer, 2 is Petal
  if(gamma.iobt() == 0){
    entryPoint_ = 0;
  } else if (gamma.iobt() == 1) {
    entryPoint_ = 1;
  } else {
    entryPoint_ = 2;
  }
...
AppResult SeExtEGCuts::endRun(AppEvent* aRun) {
  return AppResult::OK;
}

AppResult SeExtEGCuts::endJob(AppEvent* aJob) {
  ...
  if (outfile.is_open()) {
  outfile << "======================================================================================" << std::endl;
  outfile << "                     SeExtEGCuts End of Job Run Time information                     " << std::endl;
  outfile << "======================================================================================" << std::endl;
  outfile <<                                                                                             std::endl;
  ...
  outfile <<                                                                                             std::endl;
  outfile << "======================================================================================" << std::endl;
  outfile << "                      SeExtEGCuts End of Job Event Cuts Summary                      " << std::endl;
  outfile << "======================================================================================" << std::endl;
  outfile <<                                                                                             std::endl;
  ...
  outfile << std::setw(60) << std::left  << "Track associated with scintillator"
	  ...
	  <<                                                                                             std::endl;
  outfile << std::setw(60) << std::left  << "Only one unassociated calorimeter hit above 300 keV"
  ...
  outfile << std::setw(60) << std::left  << "Internal Probability < 0.04"
	  << std::setw(12) << std::right << IntProb1Percent_ 
	  << std::setw(12) << std::right << (100.0*IntProb1Percent_)/AccMCEvents_
	  <<                                                                                             std::endl;
  ...
  outfile << std::endl;
  outfile << "======================================================================================" << std::endl;
  outfile << "                     SeExtEGCuts End of Job Radon information                     " << std::endl;
  outfile << "======================================================================================" << std::endl;
  outfile <<                                                                                             std::endl;
  ...
  outfile << "====================================================================================" << std::endl;
    ...
    std::cout << "SeExtEGCuts::endJob : could not write the report" << std::endl;
    return  AppResult::ERROR;
  }
