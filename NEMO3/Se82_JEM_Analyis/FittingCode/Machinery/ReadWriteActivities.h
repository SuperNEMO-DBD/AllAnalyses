...
void printActivities(double *Activities_Ext, double *Activities_Ext_Err,
  ...
  cout << "SScin Bi210          = " << 1000*Activities_Rad[12]<< " +/- " << 1000*Activities_Rad_Err[12]<< endl;
  cout << "SScin Bi214 P1       = " << 1000*Activities_Rad[13]<< " +/- " << 1000*Activities_Rad_Err[13]<< endl;
  cout << "SScin Bi214 P2       = " << 1000*Activities_Rad[14]<< " +/- " << 1000*Activities_Rad_Err[14]<< endl;
  ...
  cout << "Signal: " << endl;
  Double_t Halflife_2b2n_SeNew     = (log(2)/(86400.0*365.25))/(Activities_Sig[0]*82.0/(6.022e4*932.4));
  Double_t Halflife_2b2n_SeNew_Err = Halflife_2b2n_SeNew*Activities_Sig_Err[0]/Activities_Sig[0];
  Double_t Halflife_2b2n_SeOld     = (log(2)/(86400.0*365.25))/(Activities_Sig[0]*82.0/(6.022e4*932.4));
  Double_t Halflife_2b2n_SeOld_Err = Halflife_2b2n_SeOld*Activities_Sig_Err[0]/Activities_Sig[0];
  cout << "2b2n SeNew (10^19 y) = " << Halflife_2b2n_SeNew << " +/- " << Halflife_2b2n_SeNew_Err << endl;
  cout << "2b2n SeOld (10^19 y) = " << Halflife_2b2n_SeOld << " +/- " << Halflife_2b2n_SeOld_Err << endl;
