#include "addChannelToStacks_1e1g.h"
#include "chiSquareTest.h"

extern THStack* StackColl_1e1g[];
extern THStack* IntStackColl_1e1g[];
extern THStack* ExtStackColl_1e1g[];
extern THStack* RadStackColl_1e1g[];
extern THStack* SigStackColl_1e1g[];
...
void addBackgrounds_1e1g(double *Activities_Ext, double *Activities_Ext_Err, double *Denominators_Ext, double *Activities_Rad, double *Activities_Rad_Err,  double *Denominators_Rad, double *Activities_Int, double *Activities_Int_Err,  double *Denominators_Int, double *Activities_Sig, double *Activities_Sig_Err, double *Denominators_Sig, double *AdjustActs, double *AdjustActs_Err){
  ...
  ExtStackColl_1e1g[0] = new THStack("h_1e1g_P1_SeOld","Electron Energy");
  ExtStackColl_1e1g[1] = new THStack("h_1e1g_P1_SeNew","Electron Energy");
  ExtStackColl_1e1g[2] = new THStack("h_1e1g_P1_Strip","Electron Energy");
  ExtStackColl_1e1g[3] = new THStack("h_1e1g_P2_SeOld","Electron Energy");
  ExtStackColl_1e1g[4] = new THStack("h_1e1g_P2_SeNew","Electron Energy");
  ExtStackColl_1e1g[5] = new THStack("h_1e1g_P2_Strip","Electron Energy");

  // Add External Backgrounds

  // 0) PMT_K40
  Double_t ScaleFactor_PMT_K40 = Act_PMT_K40*AccptRunTime/Denom_PMT_K40;
  addChannelToStacks_1e1g("PMT_K40", ScaleFactor_PMT_K40, FillColor_PMT_K40, ExtStackColl_1e1g, infile_1e1g);

  // 1) PMT_Bi214
  Double_t ScaleFactor_PMT_Bi214 = Act_PMT_Bi214*AccptRunTime/Denom_PMT_Bi214;
  addChannelToStacks_1e1g("PMT_Bi214", ScaleFactor_PMT_Bi214, FillColor_PMT_Bi214, ExtStackColl_1e1g, infile_1e1g);

  // 2) PMT_Tl208
  Double_t ScaleFactor_PMT_Tl208 = Act_PMT_Tl208*AccptRunTime/Denom_PMT_Tl208;
  addChannelToStacks_1e1g("PMT_Tl208", ScaleFactor_PMT_Tl208, FillColor_PMT_Tl208, ExtStackColl_1e1g, infile_1e1g);

  // 3) PMT_Ac228
  Double_t ScaleFactor_PMT_Ac228 = Act_PMT_Ac228*AccptRunTime/Denom_PMT_Ac228;
  addChannelToStacks_1e1g("PMT_Ac228", ScaleFactor_PMT_Ac228, FillColor_PMT_Ac228, ExtStackColl_1e1g, infile_1e1g);

  // 4) FeShield_Bi214
  Double_t ScaleFactor_FeShield_Bi214 = Act_FeShield_Bi214*AccptRunTime/Denom_FeShield_Bi214;
  addChannelToStacks_1e1g("FeShield_Bi214", ScaleFactor_FeShield_Bi214, FillColor_FeShield_Bi214, ExtStackColl_1e1g, infile_1e1g);

  // 5) FeShield_Tl208
  Double_t ScaleFactor_FeShield_Tl208 = Act_FeShield_Tl208*AccptRunTime/Denom_FeShield_Tl208;
  addChannelToStacks_1e1g("FeShield_Tl208", ScaleFactor_FeShield_Tl208, FillColor_FeShield_Tl208, ExtStackColl_1e1g, infile_1e1g);

  // 6) FeShield_Ac228
  Double_t ScaleFactor_FeShield_Ac228 = Act_FeShield_Ac228*AccptRunTime/Denom_FeShield_Ac228;
  addChannelToStacks_1e1g("FeShield_Ac228", ScaleFactor_FeShield_Ac228, FillColor_FeShield_Ac228, ExtStackColl_1e1g, infile_1e1g);

  // 7) MuMetal_Co60
  Double_t ScaleFactor_MuMetal_Co60 = Act_MuMetal_Co60*AccptRunTime/Denom_MuMetal_Co60;
  addChannelToStacks_1e1g("MuMetal_Co60", ScaleFactor_MuMetal_Co60, FillColor_MuMetal_Co60, ExtStackColl_1e1g, infile_1e1g);

  // 8) SteelFrame_K40
  Double_t ScaleFactor_SteelFrame_K40 = Act_SteelFrame_K40*AccptRunTime/Denom_SteelFrame_K40;
  addChannelToStacks_1e1g("SteelFrame_K40", ScaleFactor_SteelFrame_K40, FillColor_SteelFrame_K40, ExtStackColl_1e1g, infile_1e1g);

  // 9) SteelFrame_Bi214
  Double_t ScaleFactor_SteelFrame_Bi214 = Act_SteelFrame_Bi214*AccptRunTime/Denom_SteelFrame_Bi214;
  addChannelToStacks_1e1g("SteelFrame_Bi214", ScaleFactor_SteelFrame_Bi214, FillColor_SteelFrame_Bi214, ExtStackColl_1e1g, infile_1e1g);

  // 10) SteelFrame_Tl208
  Double_t ScaleFactor_SteelFrame_Tl208 = Act_SteelFrame_Tl208*AccptRunTime/Denom_SteelFrame_Tl208;
  addChannelToStacks_1e1g("SteelFrame_Tl208", ScaleFactor_SteelFrame_Tl208, FillColor_SteelFrame_Tl208, ExtStackColl_1e1g, infile_1e1g);

  // 11) SteelFrame_Ac228
  Double_t ScaleFactor_SteelFrame_Ac228 = Act_SteelFrame_Ac228*AccptRunTime/Denom_SteelFrame_Ac228;
  addChannelToStacks_1e1g("SteelFrame_Ac228", ScaleFactor_SteelFrame_Ac228, FillColor_SteelFrame_Ac228, ExtStackColl_1e1g, infile_1e1g);

  // 12) SteelFrame_Co60
  Double_t ScaleFactor_SteelFrame_Co60 = Act_SteelFrame_Co60*AccptRunTime/Denom_SteelFrame_Co60;
  addChannelToStacks_1e1g("SteelFrame_Co60", ScaleFactor_SteelFrame_Co60, FillColor_SteelFrame_Co60, ExtStackColl_1e1g, infile_1e1g);

  // 13) CuPetals_Co60
  Double_t ScaleFactor_CuPetals_Co60 = Act_CuPetals_Co60*AccptRunTime/Denom_CuPetals_Co60;
  addChannelToStacks_1e1g("CuPetals_Co60", ScaleFactor_CuPetals_Co60, FillColor_CuPetals_Co60, ExtStackColl_1e1g, infile_1e1g);

  // 14) CuTower_Co60
  Double_t ScaleFactor_CuTower_Co60 = Act_CuTower_Co60*AccptRunTime/Denom_CuTower_Co60;
  addChannelToStacks_1e1g("CuTower_Co60", ScaleFactor_CuTower_Co60, FillColor_CuTower_Co60, ExtStackColl_1e1g, infile_1e1g);

  // 15) ScintInn_K40
  Double_t ScaleFactor_ScintInn_K40 = Act_ScintInn_K40*AccptRunTime/Denom_ScintInn_K40;
  addChannelToStacks_1e1g("ScintInn_K40", ScaleFactor_ScintInn_K40, FillColor_ScintInn_K40, ExtStackColl_1e1g, infile_1e1g);

  // 16) ScintOut_K40
  Double_t ScaleFactor_ScintOut_K40 = Act_ScintOut_K40*AccptRunTime/Denom_ScintOut_K40;
  addChannelToStacks_1e1g("ScintOut_K40", ScaleFactor_ScintOut_K40, FillColor_ScintOut_K40, ExtStackColl_1e1g, infile_1e1g);

  // 17) ScintPet_K40
  Double_t ScaleFactor_ScintPet_K40 = Act_ScintPet_K40*AccptRunTime/Denom_ScintPet_K40;
  addChannelToStacks_1e1g("ScintPet_K40", ScaleFactor_ScintPet_K40, FillColor_ScintPet_K40, ExtStackColl_1e1g, infile_1e1g);

  // 18) SScin_Pa234m
  Double_t ScaleFactor_SScin_Pa234m = Act_SScin_Pa234m*AccptRunTime/Denom_SScin_Pa234m;
  addChannelToStacks_1e1g("SScin_Pa234m", ScaleFactor_SScin_Pa234m, FillColor_SScin_Pa234m, ExtStackColl_1e1g, infile_1e1g);

  // 19) MuMetal_g1000
  Double_t ScaleFactor_MuMetal_g1000_P1 = Act_MuMetal_g1000_P1*AccptRunTime/Denom_MuMetal_g1000;
  addChannelToStacks_1e1g("MuMetal_g1000_P1", ScaleFactor_MuMetal_g1000_P1, FillColor_MuMetal_g1000, ExtStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_MuMetal_g1000_P2 = Act_MuMetal_g1000_P2*AccptRunTime/Denom_MuMetal_g1000;
  addChannelToStacks_1e1g("MuMetal_g1000_P2", ScaleFactor_MuMetal_g1000_P2, FillColor_MuMetal_g1000, ExtStackColl_1e1g, infile_1e1g);

  // 20) Neutrons
  Double_t ScaleFactor_Neutrons_P1 = Act_Neutrons_P1*AccptRunTime/Denom_Neutrons;
  addChannelToStacks_1e1g("Data_Neutrons_P1", ScaleFactor_Neutrons_P1, FillColor_Neutrons, ExtStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_Neutrons_P2 = Act_Neutrons_P2*AccptRunTime/Denom_Neutrons;
  addChannelToStacks_1e1g("Data_Neutrons_P2", ScaleFactor_Neutrons_P2, FillColor_Neutrons, ExtStackColl_1e1g, infile_1e1g);
  ...
  // Create collection of histogram stacks
  RadStackColl_1e1g[0] = new THStack("h_1e1g_P1_SeOld","Electron Energy");
  RadStackColl_1e1g[1] = new THStack("h_1e1g_P1_SeNew","Electron Energy");
  RadStackColl_1e1g[2] = new THStack("h_1e1g_P1_Strip","Electron Energy");
  RadStackColl_1e1g[3] = new THStack("h_1e1g_P2_SeOld","Electron Energy");
  RadStackColl_1e1g[4] = new THStack("h_1e1g_P2_SeNew","Electron Energy");
  RadStackColl_1e1g[5] = new THStack("h_1e1g_P2_Strip","Electron Energy");

  //  Add Radon Backgrounds

  // 0) SWire_Bi214
  Double_t Scale_SWire_Bi214_P1 = Act_SWire_Bi214_P1*AccptRunTime/Denom_SWire_Bi214;
  addChannelToStacks_1e1g("SWire_Bi214_P1", Scale_SWire_Bi214_P1, FillColor_SWire_Bi214, RadStackColl_1e1g, infile_1e1g);
  Double_t Scale_SWire_Bi214_P2 = Act_SWire_Bi214_P2*AccptRunTime/Denom_SWire_Bi214;
  addChannelToStacks_1e1g("SWire_Bi214_P2", Scale_SWire_Bi214_P2, FillColor_SWire_Bi214, RadStackColl_1e1g, infile_1e1g);

  // 1) SWire_Pb214
  Double_t Scale_SWire_Pb214_P1 = Act_SWire_Pb214_P1*AccptRunTime/Denom_SWire_Pb214;
  addChannelToStacks_1e1g("SWire_Pb214_P1", Scale_SWire_Pb214_P1, FillColor_SWire_Pb214, RadStackColl_1e1g, infile_1e1g);
  Double_t Scale_SWire_Pb214_P2 = Act_SWire_Pb214_P2*AccptRunTime/Denom_SWire_Pb214;
  addChannelToStacks_1e1g("SWire_Pb214_P2", Scale_SWire_Pb214_P2, FillColor_SWire_Pb214, RadStackColl_1e1g, infile_1e1g);

  // 2) SWire_Bi210 
  Double_t Scale_SWire_Bi210 = Act_SWire_Bi210*AccptRunTime/Denom_SWire_Bi210;
  addChannelToStacks_1e1g("SWire_Bi210_P1", Scale_SWire_Bi210, FillColor_SWire_Bi210, RadStackColl_1e1g, infile_1e1g);
  addChannelToStacks_1e1g("SWire_Bi210_P2", Scale_SWire_Bi210, FillColor_SWire_Bi210, RadStackColl_1e1g, infile_1e1g);

  // 3) SWire_Tl208 
  Double_t Scale_SWire_Tl208_P1 = Act_SWire_Tl208_P1*AccptRunTime/Denom_SWire_Tl208;
  addChannelToStacks_1e1g("SWire_Tl208_P1", Scale_SWire_Tl208_P1, FillColor_SWire_Tl208, RadStackColl_1e1g, infile_1e1g);
  Double_t Scale_SWire_Tl208_P2 = Act_SWire_Tl208_P2*AccptRunTime/Denom_SWire_Tl208;
  addChannelToStacks_1e1g("SWire_Tl208_P2", Scale_SWire_Tl208_P2, FillColor_SWire_Tl208, RadStackColl_1e1g, infile_1e1g);

  // 4) SFoil_Bi214_In
  Double_t ScaleFactor_SFoil_Bi214_In_P1 = Act_SFoil_Bi214_In_P1*AccptRunTime/Denom_SFoil_Bi214;
  addChannelToStacks_1e1g("SFoil_Bi214_In_P1", ScaleFactor_SFoil_Bi214_In_P1, FillColor_SFoil_Bi214, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_SFoil_Bi214_In_P2 = Act_SFoil_Bi214_In_P2*AccptRunTime/Denom_SFoil_Bi214;
  addChannelToStacks_1e1g("SFoil_Bi214_In_P2", ScaleFactor_SFoil_Bi214_In_P2, FillColor_SFoil_Bi214, RadStackColl_1e1g, infile_1e1g);

  // 5) SFoil_Bi214_Out
  Double_t ScaleFactor_SFoil_Bi214_Out_P1 = Act_SFoil_Bi214_Out_P1*AccptRunTime/Denom_SFoil_Bi214;
  addChannelToStacks_1e1g("SFoil_Bi214_Out_P1", ScaleFactor_SFoil_Bi214_Out_P1, FillColor_SFoil_Bi214, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_SFoil_Bi214_Out_P2 = Act_SFoil_Bi214_Out_P2*AccptRunTime/Denom_SFoil_Bi214;
  addChannelToStacks_1e1g("SFoil_Bi214_Out_P2", ScaleFactor_SFoil_Bi214_Out_P2, FillColor_SFoil_Bi214, RadStackColl_1e1g, infile_1e1g);

  // 6) SFoil_Pb214_In
  Double_t ScaleFactor_SFoil_Pb214_In_P1 = Act_SFoil_Pb214_In_P1*AccptRunTime/Denom_SFoil_Pb214;
  addChannelToStacks_1e1g("SFoil_Pb214_In_P1", ScaleFactor_SFoil_Pb214_In_P1, FillColor_SFoil_Pb214, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_SFoil_Pb214_In_P2 = Act_SFoil_Pb214_In_P2*AccptRunTime/Denom_SFoil_Pb214;
  addChannelToStacks_1e1g("SFoil_Pb214_In_P2", ScaleFactor_SFoil_Pb214_In_P2, FillColor_SFoil_Pb214, RadStackColl_1e1g, infile_1e1g);

  // 7) SFoil_Pb214_Out
  Double_t ScaleFactor_SFoil_Pb214_Out_P1 = Act_SFoil_Pb214_Out_P1*AccptRunTime/Denom_SFoil_Pb214;
  addChannelToStacks_1e1g("SFoil_Pb214_Out_P1", ScaleFactor_SFoil_Pb214_Out_P1, FillColor_SFoil_Pb214, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_SFoil_Pb214_Out_P2 = Act_SFoil_Pb214_Out_P2*AccptRunTime/Denom_SFoil_Pb214;
  addChannelToStacks_1e1g("SFoil_Pb214_Out_P2", ScaleFactor_SFoil_Pb214_Out_P2, FillColor_SFoil_Pb214, RadStackColl_1e1g, infile_1e1g);

  // 8) SFoil_SeNew_Bi210 
  Double_t ScaleFactor_SFoil_SeNew_Bi210 = Act_SFoil_SeNew_Bi210*AccptRunTime/Denom_SFoil_Bi210;
  addChannelToStacks_1e1g("SFoil_SeNew_Bi210_P1", ScaleFactor_SFoil_SeNew_Bi210, FillColor_SFoil_Bi210, RadStackColl_1e1g, infile_1e1g);
  addChannelToStacks_1e1g("SFoil_SeNew_Bi210_P2", ScaleFactor_SFoil_SeNew_Bi210, FillColor_SFoil_Bi210, RadStackColl_1e1g, infile_1e1g);

  // 9) SFoil_SeOld_Bi210 
  Double_t ScaleFactor_SFoil_SeOld_Bi210 = Act_SFoil_SeOld_Bi210*AccptRunTime/Denom_SFoil_Bi210;
  addChannelToStacks_1e1g("SFoil_SeOld_Bi210_P1", ScaleFactor_SFoil_SeOld_Bi210, FillColor_SFoil_Bi210, RadStackColl_1e1g, infile_1e1g);
  addChannelToStacks_1e1g("SFoil_SeOld_Bi210_P2", ScaleFactor_SFoil_SeOld_Bi210, FillColor_SFoil_Bi210, RadStackColl_1e1g, infile_1e1g);
  ...
  addChannelToStacks_1e1g("SFoil_Strip_Bi210_P1", ScaleFactor_SFoil_Strip_Bi210, FillColor_SFoil_Bi210, RadStackColl_1e1g, infile_1e1g);
  addChannelToStacks_1e1g("SFoil_Strip_Bi210_P2", ScaleFactor_SFoil_Strip_Bi210, FillColor_SFoil_Bi210, RadStackColl_1e1g, infile_1e1g);

  // 11) SScin_Bi214
  Double_t ScaleFactor_SScin_Bi214_P1 = Act_SScin_Bi214_P1*AccptRunTime/Denom_SScin_Bi214;
  addChannelToStacks_1e1g("SScin_Bi214_P1", ScaleFactor_SScin_Bi214_P1, FillColor_SScin_Bi214, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_SScin_Bi214_P2 = Act_SScin_Bi214_P2*AccptRunTime/Denom_SScin_Bi214;
  addChannelToStacks_1e1g("SScin_Bi214_P2", ScaleFactor_SScin_Bi214_P2, FillColor_SScin_Bi214, RadStackColl_1e1g, infile_1e1g);

  // 12) SScin_Pb214
  Double_t ScaleFactor_SScin_Pb214_P1 = Act_SScin_Pb214_P1*AccptRunTime/Denom_SScin_Pb214;
  addChannelToStacks_1e1g("SScin_Pb214_P1", ScaleFactor_SScin_Pb214_P1, FillColor_SScin_Pb214, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_SScin_Pb214_P2 = Act_SScin_Pb214_P2*AccptRunTime/Denom_SScin_Pb214;
  addChannelToStacks_1e1g("SScin_Pb214_P2", ScaleFactor_SScin_Pb214_P2, FillColor_SScin_Pb214, RadStackColl_1e1g, infile_1e1g);

  // 13) SScin_Bi210
  Double_t ScaleFactor_SScin_Bi210 = Act_SScin_Bi210*AccptRunTime/Denom_SScin_Bi210;
  addChannelToStacks_1e1g("SScin_Bi210_P1", ScaleFactor_SScin_Bi210, FillColor_SScin_Bi210, RadStackColl_1e1g, infile_1e1g);
  addChannelToStacks_1e1g("SScin_Bi210_P2", ScaleFactor_SScin_Bi210, FillColor_SScin_Bi210, RadStackColl_1e1g, infile_1e1g);

  // 14) Air_Bi214
  Double_t ScaleFactor_Air_Bi214_P1 = Act_Air_Bi214_P1*AccptRunTime/Denom_Air_Bi214;
  addChannelToStacks_1e1g("Air_Bi214_P1", ScaleFactor_Air_Bi214_P1, FillColor_Air_Bi214, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_Air_Bi214_P2 = Act_Air_Bi214_P2*AccptRunTime/Denom_Air_Bi214;
  addChannelToStacks_1e1g("Air_Bi214_P2", ScaleFactor_Air_Bi214_P2, FillColor_Air_Bi214, RadStackColl_1e1g, infile_1e1g);

  // 15) Air_Pb214
  Double_t ScaleFactor_Air_Pb214_P1 = Act_Air_Pb214_P1*AccptRunTime/Denom_Air_Pb214;
  addChannelToStacks_1e1g("Air_Pb214_P1", ScaleFactor_Air_Pb214_P1, FillColor_Air_Pb214, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_Air_Pb214_P2 = Act_Air_Pb214_P2*AccptRunTime/Denom_Air_Pb214;
  addChannelToStacks_1e1g("Air_Pb214_P2", ScaleFactor_Air_Pb214_P2, FillColor_Air_Pb214, RadStackColl_1e1g, infile_1e1g);

  // 16) Air_Tl208
  Double_t ScaleFactor_Air_Tl208_P1 = Act_Air_Tl208_P1*AccptRunTime/Denom_Air_Tl208;
  addChannelToStacks_1e1g("Air_Tl208_P1", ScaleFactor_Air_Tl208_P1, FillColor_Air_Tl208, RadStackColl_1e1g, infile_1e1g);
  Double_t ScaleFactor_Air_Tl208_P2 = Act_Air_Tl208_P2*AccptRunTime/Denom_Air_Tl208;
  addChannelToStacks_1e1g("Air_Tl208_P2", ScaleFactor_Air_Tl208_P2, FillColor_Air_Tl208, RadStackColl_1e1g, infile_1e1g);
  ...
  // Create collection of histogram stacks
  IntStackColl_1e1g[0] = new THStack("h_1e1g_P1_SeOld","Electron Energy");
  IntStackColl_1e1g[1] = new THStack("h_1e1g_P1_SeNew","Electron Energy");
  IntStackColl_1e1g[2] = new THStack("h_1e1g_P1_Strip","Electron Energy");
  IntStackColl_1e1g[3] = new THStack("h_1e1g_P2_SeOld","Electron Energy");
  IntStackColl_1e1g[4] = new THStack("h_1e1g_P2_SeNew","Electron Energy");
  IntStackColl_1e1g[5] = new THStack("h_1e1g_P2_Strip","Electron Energy");

  // Add Internal Backgrounds

  // 0) SeNew_Bi214
  Double_t ScaleFactor_SeNew_Bi214 = Act_SeNew_Bi214*AccptRunTime/Denom_SeNew_Bi214;
  addChannelToStacks_1e1g("SeNew_Bi214", ScaleFactor_SeNew_Bi214, FillColor_SeNew_Bi214, IntStackColl_1e1g, infile_1e1g);

  // 1) SeOld_Bi214
  Double_t ScaleFactor_SeOld_Bi214 = Act_SeOld_Bi214*AccptRunTime/Denom_SeOld_Bi214;
  addChannelToStacks_1e1g("SeOld_Bi214", ScaleFactor_SeOld_Bi214, FillColor_SeOld_Bi214, IntStackColl_1e1g, infile_1e1g);

  // 2) Mylar_Bi214
  Double_t ScaleFactor_Mylar_Bi214 = Act_Mylar_Bi214*AccptRunTime/Denom_Mylar_Bi214;
  addChannelToStacks_1e1g("Mylar_Bi214", ScaleFactor_Mylar_Bi214, FillColor_Mylar_Bi214, IntStackColl_1e1g, infile_1e1g);

  // 3) SeNew_Pb214
  Double_t ScaleFactor_SeNew_Pb214 = Act_SeNew_Pb214*AccptRunTime/Denom_SeNew_Pb214;
  addChannelToStacks_1e1g("SeNew_Pb214", ScaleFactor_SeNew_Pb214, FillColor_SeNew_Pb214, IntStackColl_1e1g, infile_1e1g);

  // 4) SeOld_Pb214
  Double_t ScaleFactor_SeOld_Pb214 = Act_SeOld_Pb214*AccptRunTime/Denom_SeOld_Pb214;
  addChannelToStacks_1e1g("SeOld_Pb214", ScaleFactor_SeOld_Pb214, FillColor_SeOld_Pb214, IntStackColl_1e1g, infile_1e1g);

  // 5) Mylar_Pb214
  Double_t ScaleFactor_Mylar_Pb214 = Act_Mylar_Pb214*AccptRunTime/Denom_Mylar_Pb214;
  addChannelToStacks_1e1g("Mylar_Pb214", ScaleFactor_Mylar_Pb214, FillColor_Mylar_Pb214, IntStackColl_1e1g, infile_1e1g);

  // 6) SeNew_Tl208
  Double_t ScaleFactor_SeNew_Tl208 = Act_SeNew_Tl208*AccptRunTime/Denom_SeNew_Tl208;
  addChannelToStacks_1e1g("SeNew_Tl208", ScaleFactor_SeNew_Tl208, FillColor_SeNew_Tl208, IntStackColl_1e1g, infile_1e1g);

  // 7) SeOld_Tl208
  Double_t ScaleFactor_SeOld_Tl208 = Act_SeOld_Tl208*AccptRunTime/Denom_SeOld_Tl208;
  addChannelToStacks_1e1g("SeOld_Tl208", ScaleFactor_SeOld_Tl208, FillColor_SeOld_Tl208, IntStackColl_1e1g, infile_1e1g);

  // 8) SeNew_Bi212
  Double_t ScaleFactor_SeNew_Bi212 = Act_SeNew_Bi212*AccptRunTime/Denom_SeNew_Bi212;
  addChannelToStacks_1e1g("SeNew_Bi212", ScaleFactor_SeNew_Bi212, FillColor_SeNew_Bi212, IntStackColl_1e1g, infile_1e1g);

  // 9) SeOld_Bi212
  Double_t ScaleFactor_SeOld_Bi212 = Act_SeOld_Bi212*AccptRunTime/Denom_SeOld_Bi212;
  addChannelToStacks_1e1g("SeOld_Bi212", ScaleFactor_SeOld_Bi212, FillColor_SeOld_Bi212, IntStackColl_1e1g, infile_1e1g);

  // 10) SeNew_Ac228
  Double_t ScaleFactor_SeNew_Ac228 = Act_SeNew_Ac228*AccptRunTime/Denom_SeNew_Ac228;
  addChannelToStacks_1e1g("SeNew_Ac228", ScaleFactor_SeNew_Ac228, FillColor_SeNew_Ac228, IntStackColl_1e1g, infile_1e1g);

  // 11) SeOld_Ac228
  Double_t ScaleFactor_SeOld_Ac228 = Act_SeOld_Ac228*AccptRunTime/Denom_SeOld_Ac228;
  addChannelToStacks_1e1g("SeOld_Ac228", ScaleFactor_SeOld_Ac228, FillColor_SeOld_Ac228, IntStackColl_1e1g, infile_1e1g);

  // 12) SeNew_Pa234m
  Double_t ScaleFactor_SeNew_Pa234m = Act_SeNew_Pa234m*AccptRunTime/Denom_SeNew_Pa234m;
  addChannelToStacks_1e1g("SeNew_Pa234m", ScaleFactor_SeNew_Pa234m, FillColor_SeNew_Pa234m, IntStackColl_1e1g, infile_1e1g);

  // 13) SeOld_Pa234m
  Double_t ScaleFactor_SeOld_Pa234m = Act_SeOld_Pa234m*AccptRunTime/Denom_SeOld_Pa234m;
  addChannelToStacks_1e1g("SeOld_Pa234m", ScaleFactor_SeOld_Pa234m, FillColor_SeOld_Pa234m, IntStackColl_1e1g, infile_1e1g);

  // 14) SeNew_K40
  Double_t ScaleFactor_SeNew_K40 = Act_SeNew_K40*AccptRunTime/Denom_SeNew_K40;
  addChannelToStacks_1e1g("SeNew_K40", ScaleFactor_SeNew_K40, FillColor_SeNew_K40, IntStackColl_1e1g, infile_1e1g);

  // 15) SeOld_K40
  Double_t ScaleFactor_SeOld_K40 = Act_SeOld_K40*AccptRunTime/Denom_SeOld_K40;
  addChannelToStacks_1e1g("SeOld_K40", ScaleFactor_SeOld_K40, FillColor_SeOld_K40, IntStackColl_1e1g, infile_1e1g);
  ...
  // Create collection of histogram stacks
  SigStackColl_1e1g[0] = new THStack("h_1e1g_P1_SeOld","Electron Energy");
  SigStackColl_1e1g[1] = new THStack("h_1e1g_P1_SeNew","Electron Energy");
  SigStackColl_1e1g[2] = new THStack("h_1e1g_P1_Strip","Electron Energy");
  SigStackColl_1e1g[3] = new THStack("h_1e1g_P2_SeOld","Electron Energy");
  SigStackColl_1e1g[4] = new THStack("h_1e1g_P2_SeNew","Electron Energy");
  SigStackColl_1e1g[5] = new THStack("h_1e1g_P2_Strip","Electron Energy");

  // 0) 2b2n - SeNew
  Double_t ScaleFactor_2b2n_SeNew = Act_2b2n_SeNew*AccptRunTime/Denom_2b2n_SeNew;
  addChannelToStacks_1e1g("2b2n_SeNew", ScaleFactor_2b2n_SeNew, FillColor_2b2n, SigStackColl_1e1g, infile_1e1g);

  // 1) 2b2n - SeOld
  Double_t ScaleFactor_2b2n_SeOld = Act_2b2n_SeOld*AccptRunTime/Denom_2b2n_SeOld;
  addChannelToStacks_1e1g("2b2n_SeOld", ScaleFactor_2b2n_SeOld, FillColor_2b2n, SigStackColl_1e1g, infile_1e1g);
  ...
  StackColl_1e1g[0] = new THStack("h_1e1g_P1_SeOld","Electron Energy");
  StackColl_1e1g[1] = new THStack("h_1e1g_P1_SeNew","Electron Energy");
  StackColl_1e1g[2] = new THStack("h_1e1g_P1_Strip","Electron Energy");
  StackColl_1e1g[3] = new THStack("h_1e1g_P2_SeOld","Electron Energy");
  StackColl_1e1g[4] = new THStack("h_1e1g_P2_SeNew","Electron Energy");
  StackColl_1e1g[5] = new THStack("h_1e1g_P2_Strip","Electron Energy");

  // 0) K40 External Backgrounds
  for(int j = 0; j < 6; j++){
    TH1D* hK40 = (TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(0)->Clone("hK40");
    hK40->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(8), 1);
    hK40->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(7),-1);
    hK40->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(17),1);
    hK40->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(14),-1);
    hK40->SetFillColor(kSpring-6);
    StackColl_1e1g[j]->Add(hK40);
  }

  // 1) Bi214 External Backgrounds (include SScin here too)
  for(int j = 0; j < 6; j++){
    TH1D* hBi214 = (TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(1)->Clone("hBi214");
    hBi214->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(0),-1);
    hBi214->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(4), 1);
    hBi214->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(3),-1);
    hBi214->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(9),1);
    hBi214->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(8),-1);
    TH1D* hSScin = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(12)->Clone("hSScin");
    hSScin->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(10), -1);
    hBi214->Add(hSScin);
    hBi214->SetFillColor(kSpring-1);
    StackColl_1e1g[j]->Add(hBi214);
  }

  // 2) Tl208 & Ac228 External Backgrounds
  for(int j = 0; j < 6; j++){
    TH1D* hTl208 = (TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(3)->Clone("hTl208");
    hTl208->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(1),-1);
    hTl208->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(6), 1);
    hTl208->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(4),-1);
    hTl208->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(11),1);
    hTl208->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(9),-1);
    hTl208->SetFillColor(kSpring-3);
    StackColl_1e1g[j]->Add(hTl208);
  }

  // 3) Co60 External Backgrounds
  for(int j = 0; j < 6; j++){
    TH1D* hCo60 = (TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(7)->Clone("hCo60");
    hCo60->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(6),-1);
    hCo60->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(14), 1);
    hCo60->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(11),-1);
    hCo60->SetFillColor(kSpring-4);
    StackColl_1e1g[j]->Add(hCo60);
  }

  // 4) Pa234m_SScin External Backgrounds
  for(int j = 0; j < 6; j++){
    TH1D* hSScin_Pa234m = (TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(18)->Clone("hSScin_Pa234m");
    hSScin_Pa234m->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(17),-1);
    hSScin_Pa234m->SetFillColor(kSpring-5);
    StackColl_1e1g[j]->Add(hSScin_Pa234m);
  }

  // 5) MuMetal_g1000 External Backgrounds
  for(int j = 0; j < 6; j++){
    TH1D* hMuMetal_g100 = (TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(19)->Clone("hMuMetal_g100");
    hMuMetal_g100->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(18),-1);
    hMuMetal_g100->SetFillColor(kSpring-7);
    StackColl_1e1g[j]->Add(hMuMetal_g100);
  }

  // 6) Neutrons External Backgrounds
  for(int j = 0; j < 6; j++){
    TH1D* hNeutrons = (TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(20)->Clone("hNeutrons");
    hNeutrons->Add((TH1D*)ExtStackColl_1e1g[j]->GetStack()->At(19),-1);
    hNeutrons->SetFillColor(kSpring-8);
    StackColl_1e1g[j]->Add(hNeutrons);
  }

  // 7)  Bi214 LSM Air
  for(int j = 0; j < 6; j++){
    TH1D* hAir = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(15)->Clone("hAir");
    hAir->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(13), -1);
    hAir->SetFillColor(kPink-1);
    StackColl_1e1g[j]->Add(hAir);
  }

  // 8)  Tl208 LSM Air
  for(int j = 0; j < 6; j++){
    TH1D* hAir = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(16)->Clone("hAir");
    hAir->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(15), -1);
  ...
  // 9) 1e1a Backgrounds
  for(int j = 0; j < 6; j++){
    TH1D* hSWire = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(1)->Clone("hSWire");

    TH1D* hSFoil = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(7)->Clone("hSFoil");
    hSFoil->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(3), -1);

    TH1D* hInternals = (TH1D*)IntStackColl_1e1g[j]->GetStack()->At(5)->Clone("hInternals");

    hSWire->Add(hInternals);
    hSWire->Add(hSFoil);
    hSWire->SetFillColor(kRed);
    StackColl_1e1g[j]->Add(hSWire);
  }

  // 10) 1e2g samples
  for(int j = 0; j < 6; j++){
    TH1D* hSWire = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(3)->Clone("hSWire");
    hSWire->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(2), -1);
    TH1D* hInternals = (TH1D*)IntStackColl_1e1g[j]->GetStack()->At(11)->Clone("hInternals");
    hInternals->Add((TH1D*)IntStackColl_1e1g[j]->GetStack()->At(5), -1);
    hSWire->Add(hInternals);
  ...
  // 11) Bi210 SScin
  for(int j = 0; j < 6; j++){
    TH1D* hSScin = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(13)->Clone("hSScin");
    hSScin->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(12), -1);
    hSScin->SetFillColor(kOrange-1);
    StackColl_1e1g[j]->Add(hSScin);
  }

  // 12) SWire-B210
  for(int j = 0; j < 6; j++){
    TH1D* hSWire = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(2)->Clone("hSWire");
    hSWire->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(1), -1);
  ...
  for(int j = 0; j < 6; j++){
    TH1D* hSFoil = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(8)->Clone("hSFoil");
    hSFoil->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(7), -1);
    hSFoil->SetFillColor(kYellow);
    StackColl_1e1g[j]->Add(hSFoil);
  }

  // 14) Bi210 SFoil SeOld
  for(int j = 0; j < 6; j++){
    TH1D* hSFoil = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(9)->Clone("hSFoil");
    hSFoil->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(8), -1);
    hSFoil->SetFillColor(kYellow);
    StackColl_1e1g[j]->Add(hSFoil);
  }
  ...
  for(int j = 0; j < 6; j++){
    TH1D* hSFoil = (TH1D*)RadStackColl_1e1g[j]->GetStack()->At(10)->Clone("hSFoil");
    hSFoil->Add((TH1D*)RadStackColl_1e1g[j]->GetStack()->At(9), -1);
    hSFoil->SetFillColor(kYellow);
    StackColl_1e1g[j]->Add(hSFoil);
  }
  ...
  // 16) Pa234m - SeNew
  for(int j = 0; j < 6; j++){
    TH1D* hPa234m = (TH1D*)IntStackColl_1e1g[j]->GetStack()->At(12)->Clone("hPa234m");
    hPa234m->Add((TH1D*)IntStackColl_1e1g[j]->GetStack()->At(11), -1);
    hPa234m->SetFillColor(kAzure-2);
    StackColl_1e1g[j]->Add(hPa234m);
  }

  // 17) Pa234m - SeOld
  for(int j = 0; j < 6; j++){
    TH1D* hPa234m = (TH1D*)IntStackColl_1e1g[j]->GetStack()->At(13)->Clone("hPa234m");
    hPa234m->Add((TH1D*)IntStackColl_1e1g[j]->GetStack()->At(12), -1);
    hPa234m->SetFillColor(kAzure-2);
    StackColl_1e1g[j]->Add(hPa234m);
  }
  ...
  // 18) K40 - SeNew
  for(int j = 0; j < 6; j++){
    TH1D* hK40 = (TH1D*)IntStackColl_1e1g[j]->GetStack()->At(14)->Clone("hK40");
    hK40->Add((TH1D*)IntStackColl_1e1g[j]->GetStack()->At(13), -1);
  ...
  // 19) K40 - SeOld
  for(int j = 0; j < 6; j++){
    TH1D* hK40 = (TH1D*)IntStackColl_1e1g[j]->GetStack()->At(15)->Clone("hK40");
    hK40->Add((TH1D*)IntStackColl_1e1g[j]->GetStack()->At(14), -1);
    hK40->SetFillColor(kOrange+10);
    StackColl_1e1g[j]->Add(hK40);
  }
  ...
  // 20) 2b2n - SeOld & SeNew
  for(int j = 0; j < 6; j++){
    TH1D* h2b2n = (TH1D*)SigStackColl_1e1g[j]->GetStack()->Last()->Clone("h2b2n");
    h2b2n->SetFillColor(kRed);
    StackColl_1e1g[j]->Add(h2b2n);
  }
  ...
  // Make legends
  for(int i = 0; i < 6; i++){
    Legend_1e1g[i] = new TLegend(0.540,0.4845,0.947,0.947);
    Legend_1e1g[i]->SetNColumns(2);
    Legend_1e1g[i]->SetColumnSeparation(-0.05);
    Legend_1e1g[i]->SetFillColor(0);
    Legend_1e1g[i]->SetLineColor(0);
    Legend_1e1g[i]->SetBorderSize(0);
    LegendLog_1e1g[i] = new TLegend(0.7199,0.4845,0.947,0.947);
    LegendLog_1e1g[i]->SetFillColor(0);
    LegendLog_1e1g[i]->SetLineColor(0);
    LegendLog_1e1g[i]->SetBorderSize(0);
  }

  char Num_Events[40];

  sprintf (Num_Events, "%d Events", (int) h_1e1g_Data_P1_SeOld->GetEntries());
  Legend_1e1g[0]->AddEntry(h_1e1g_Data_P1_SeOld, "Data", "lpe");
  Legend_1e1g[0]->AddEntry(h_1e1g_Data_P1_SeOld, Num_Events, "");
  LegendLog_1e1g[0]->AddEntry(h_1e1g_Data_P1_SeOld, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_1e1g_Data_P1_SeNew->GetEntries());
  Legend_1e1g[1]->AddEntry(h_1e1g_Data_P1_SeNew, "Data", "lpe");
  Legend_1e1g[1]->AddEntry(h_1e1g_Data_P1_SeNew, Num_Events, "");
  LegendLog_1e1g[1]->AddEntry(h_1e1g_Data_P1_SeNew, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_1e1g_Data_P1_Strip->GetEntries());
  Legend_1e1g[2]->AddEntry(h_1e1g_Data_P1_Strip, "Data", "lpe");
  Legend_1e1g[2]->AddEntry(h_1e1g_Data_P1_Strip, Num_Events, "");
  LegendLog_1e1g[2]->AddEntry(h_1e1g_Data_P1_Strip, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_1e1g_Data_P2_SeOld->GetEntries());
  Legend_1e1g[3]->AddEntry(h_1e1g_Data_P2_SeOld, "Data", "lpe");
  Legend_1e1g[3]->AddEntry(h_1e1g_Data_P2_SeOld, Num_Events, "");
  LegendLog_1e1g[3]->AddEntry(h_1e1g_Data_P2_SeOld, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_1e1g_Data_P2_SeNew->GetEntries());
  Legend_1e1g[4]->AddEntry(h_1e1g_Data_P2_SeNew, "Data", "lpe");
  Legend_1e1g[4]->AddEntry(h_1e1g_Data_P2_SeNew, Num_Events, "");
  LegendLog_1e1g[4]->AddEntry(h_1e1g_Data_P2_SeNew, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_1e1g_Data_P2_Strip->GetEntries());
  Legend_1e1g[5]->AddEntry(h_1e1g_Data_P2_Strip, "Data", "lpe");
  Legend_1e1g[5]->AddEntry(h_1e1g_Data_P2_Strip, Num_Events, "");
  LegendLog_1e1g[5]->AddEntry(h_1e1g_Data_P2_Strip, "Data", "lpe");
  ...
  for(int j = 0; j < 6; j++){
    ...
    if(j % 3 == 0){
      if(j < 3){
	TH1 *h;
	TIter   next(StackColl_1e1g[j]->GetHists());
	for(int i = 0; i < 13; i++){
	  h = (TH1*) next();
	  Legend_1e1g[j]->AddEntry(h, LegIsotopes_SeOld_P1[i].c_str(), "f");
	  Legend_1e1g[j]->AddEntry(h, LegEntries_SeOld_P1[i].c_str(), "");
	  LegendLog_1e1g[j]->AddEntry(h, LegIsotopes_SeOld_P1[i].c_str(), "f");
	}
 	h = (TH1*) next();
 	for(int i = 13; i < 16; i++){
 	  h = (TH1*) next(); 
	...
	for(int i = 0; i < 13; i++){
	  h = (TH1*) next();
	  Legend_1e1g[j]->AddEntry(h, LegIsotopes_SeOld_P2[i].c_str(), "f");
	  Legend_1e1g[j]->AddEntry(h, LegEntries_SeOld_P2[i].c_str(), "");
	  LegendLog_1e1g[j]->AddEntry(h, LegIsotopes_SeOld_P2[i].c_str(), "f");
	}
 	h = (TH1*) next();
 	for(int i = 13; i < 16; i++){
 	  h = (TH1*) next(); 
	...
	for(int i = 0; i < 13; i++){
	  h = (TH1*) next();
	  Legend_1e1g[j]->AddEntry(h, LegIsotopes_SeNew_P1[i].c_str(), "f");
	  Legend_1e1g[j]->AddEntry(h, LegEntries_SeNew_P1[i].c_str(), "");
	  LegendLog_1e1g[j]->AddEntry(h, LegIsotopes_SeNew_P1[i].c_str(), "f");
	}
 	h = (TH1*) next();
 	for(int i = 13; i < 16; i++){
 	  h = (TH1*) next(); 
	...
	for(int i = 0; i < 13; i++){
	  h = (TH1*) next();
	  Legend_1e1g[j]->AddEntry(h, LegIsotopes_SeNew_P2[i].c_str(), "f");
	  Legend_1e1g[j]->AddEntry(h, LegEntries_SeNew_P2[i].c_str(), "");
	  LegendLog_1e1g[j]->AddEntry(h, LegIsotopes_SeNew_P2[i].c_str(), "f");
	}
 	h = (TH1*) next();
 	for(int i = 13; i < 16; i++){
 	  h = (TH1*) next(); 
	...
	for(int i = 0; i < 13; i++){
	  h = (TH1*) next();
	  Legend_1e1g[j]->AddEntry(h, LegIsotopes_Strip_P1[i].c_str(), "f");
	  Legend_1e1g[j]->AddEntry(h, LegEntries_Strip_P1[i].c_str(), "");
	  LegendLog_1e1g[j]->AddEntry(h, LegIsotopes_Strip_P1[i].c_str(), "f");
	}
 	h = (TH1*) next();
 	for(int i = 13; i < 16; i++){
 	  h = (TH1*) next(); 
	...
	for(int i = 0; i < 13; i++){
	  h = (TH1*) next();
	  Legend_1e1g[j]->AddEntry(h, LegIsotopes_Strip_P2[i].c_str(), "f");
	  Legend_1e1g[j]->AddEntry(h, LegEntries_Strip_P2[i].c_str(), "");
	  LegendLog_1e1g[j]->AddEntry(h, LegIsotopes_Strip_P2[i].c_str(), "f");
	}
 	h = (TH1*) next();
 	for(int i = 13; i < 16; i++){
 	  h = (TH1*) next(); 
  ...
  for (int i = 0; i < 6; i++){
    ChiSquares_1e1g[i] = new TPaveText(0.587,0.435,0.762,0.475,"LNDC");
    ChiSquares_1e1g[i]->SetFillColor(0);
    ChiSquares_1e1g[i]->SetLineColor(0);
    ChiSquares_1e1g[i]->SetBorderSize(0);
    ChiSquares_1e1g[i]->SetTextAlign(12);

    ChiSquaresLog_1e1g[i] = new TPaveText(0.737,0.427,0.921,0.467,"LNDC");
    ChiSquaresLog_1e1g[i]->SetFillColor(0);
    ChiSquaresLog_1e1g[i]->SetLineColor(0);
    ChiSquaresLog_1e1g[i]->SetBorderSize(0);
    ChiSquaresLog_1e1g[i]->SetTextAlign(12);
  }

  pair <Double_t, Int_t> ChiSquareResult;
  char ChiSquareText[100];

  ChiSquareResult = ChiSquareTest(h_1e1g_Data_P1_SeOld, (TH1D*)StackColl_1e1g[0]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_1e1g[0]->AddText(ChiSquareText);
  ChiSquaresLog_1e1g[0]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_1e1g_Data_P1_SeNew, (TH1D*)StackColl_1e1g[1]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_1e1g[1]->AddText(ChiSquareText);
  ChiSquaresLog_1e1g[1]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_1e1g_Data_P1_Strip, (TH1D*)StackColl_1e1g[2]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_1e1g[2]->AddText(ChiSquareText);
  ChiSquaresLog_1e1g[2]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_1e1g_Data_P2_SeOld, (TH1D*)StackColl_1e1g[3]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_1e1g[3]->AddText(ChiSquareText);
  ChiSquaresLog_1e1g[3]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_1e1g_Data_P2_SeNew, (TH1D*)StackColl_1e1g[4]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_1e1g[4]->AddText(ChiSquareText);
  ChiSquaresLog_1e1g[4]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_1e1g_Data_P2_Strip, (TH1D*)StackColl_1e1g[5]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_1e1g[5]->AddText(ChiSquareText);
  ChiSquaresLog_1e1g[5]->AddText(ChiSquareText);
