#include "addChannelToStacks_ExtEG.h"
...
void addBackgrounds_ExtEG(double *Activities_Ext, double *Activities_Ext_Err, double *Denominators_Ext, double *Activities_Rad, double *Activities_Rad_Err,  double *Denominators_Rad, double *Activities_Int, double *Activities_Int_Err,  double *Denominators_Int, double *Activities_Sig, double *Activities_Sig_Err, double *Denominators_Sig, double *AdjustActs, double *AdjustActs_Err){
  ...
  ExtStackColl_ExtEG[0] = new THStack("h_ExtEG_P1_Inner","Electron Energy");
  ExtStackColl_ExtEG[1] = new THStack("h_ExtEG_P1_Outer","Electron Energy");
  ExtStackColl_ExtEG[2] = new THStack("h_ExtEG_P1_Petal","Electron Energy");
  ExtStackColl_ExtEG[3] = new THStack("h_ExtEG_P2_Inner","Electron Energy");
  ExtStackColl_ExtEG[4] = new THStack("h_ExtEG_P2_Outer","Electron Energy");
  ExtStackColl_ExtEG[5] = new THStack("h_ExtEG_P2_Petal","Electron Energy");

  // Add External Backgrounds

  // 0) PMT_K40
  Double_t ScaleFactor_PMT_K40 = Act_PMT_K40*AccptRunTime/Denom_PMT_K40;
  addChannelToStacks_ExtEG("PMT_K40", ScaleFactor_PMT_K40, FillColor_PMT_K40, ExtStackColl_ExtEG, infile_ExtEG);

  // 1) PMT_Bi214
  Double_t ScaleFactor_PMT_Bi214 = Act_PMT_Bi214*AccptRunTime/Denom_PMT_Bi214;
  addChannelToStacks_ExtEG("PMT_Bi214", ScaleFactor_PMT_Bi214, FillColor_PMT_Bi214, ExtStackColl_ExtEG, infile_ExtEG);

  // 2) PMT_Tl208
  Double_t ScaleFactor_PMT_Tl208 = Act_PMT_Tl208*AccptRunTime/Denom_PMT_Tl208;
  addChannelToStacks_ExtEG("PMT_Tl208", ScaleFactor_PMT_Tl208, FillColor_PMT_Tl208, ExtStackColl_ExtEG, infile_ExtEG);

  // 3) PMT_Ac228
  Double_t ScaleFactor_PMT_Ac228 = Act_PMT_Ac228*AccptRunTime/Denom_PMT_Ac228;
  addChannelToStacks_ExtEG("PMT_Ac228", ScaleFactor_PMT_Ac228, FillColor_PMT_Ac228, ExtStackColl_ExtEG, infile_ExtEG);

  // 4) FeShield_Bi214
  Double_t ScaleFactor_FeShield_Bi214 = Act_FeShield_Bi214*AccptRunTime/Denom_FeShield_Bi214;
  addChannelToStacks_ExtEG("FeShield_Bi214", ScaleFactor_FeShield_Bi214, FillColor_FeShield_Bi214, ExtStackColl_ExtEG, infile_ExtEG);

  // 5) FeShield_Tl208
  Double_t ScaleFactor_FeShield_Tl208 = Act_FeShield_Tl208*AccptRunTime/Denom_FeShield_Tl208;
  addChannelToStacks_ExtEG("FeShield_Tl208", ScaleFactor_FeShield_Tl208, FillColor_FeShield_Tl208, ExtStackColl_ExtEG, infile_ExtEG);

  // 6) FeShield_Ac228
  Double_t ScaleFactor_FeShield_Ac228 = Act_FeShield_Ac228*AccptRunTime/Denom_FeShield_Ac228;
  addChannelToStacks_ExtEG("FeShield_Ac228", ScaleFactor_FeShield_Ac228, FillColor_FeShield_Ac228, ExtStackColl_ExtEG, infile_ExtEG);

  // 7) MuMetal_Co60
  Double_t ScaleFactor_MuMetal_Co60 = Act_MuMetal_Co60*AccptRunTime/Denom_MuMetal_Co60;
  addChannelToStacks_ExtEG("MuMetal_Co60", ScaleFactor_MuMetal_Co60, FillColor_MuMetal_Co60, ExtStackColl_ExtEG, infile_ExtEG);

  // 8) SteelFrame_K40
  Double_t ScaleFactor_SteelFrame_K40 = Act_SteelFrame_K40*AccptRunTime/Denom_SteelFrame_K40;
  addChannelToStacks_ExtEG("SteelFrame_K40", ScaleFactor_SteelFrame_K40, FillColor_SteelFrame_K40, ExtStackColl_ExtEG, infile_ExtEG);

  // 9) SteelFrame_Bi214
  Double_t ScaleFactor_SteelFrame_Bi214 = Act_SteelFrame_Bi214*AccptRunTime/Denom_SteelFrame_Bi214;
  addChannelToStacks_ExtEG("SteelFrame_Bi214", ScaleFactor_SteelFrame_Bi214, FillColor_SteelFrame_Bi214, ExtStackColl_ExtEG, infile_ExtEG);

  // 10) SteelFrame_Tl208
  Double_t ScaleFactor_SteelFrame_Tl208 = Act_SteelFrame_Tl208*AccptRunTime/Denom_SteelFrame_Tl208;
  addChannelToStacks_ExtEG("SteelFrame_Tl208", ScaleFactor_SteelFrame_Tl208, FillColor_SteelFrame_Tl208, ExtStackColl_ExtEG, infile_ExtEG);

  // 11) SteelFrame_Ac228
  Double_t ScaleFactor_SteelFrame_Ac228 = Act_SteelFrame_Ac228*AccptRunTime/Denom_SteelFrame_Ac228;
  addChannelToStacks_ExtEG("SteelFrame_Ac228", ScaleFactor_SteelFrame_Ac228, FillColor_SteelFrame_Ac228, ExtStackColl_ExtEG, infile_ExtEG);

  // 12) SteelFrame_Co60
  Double_t ScaleFactor_SteelFrame_Co60 = Act_SteelFrame_Co60*AccptRunTime/Denom_SteelFrame_Co60;
  addChannelToStacks_ExtEG("SteelFrame_Co60", ScaleFactor_SteelFrame_Co60, FillColor_SteelFrame_Co60, ExtStackColl_ExtEG, infile_ExtEG);

  // 13) CuPetals_Co60
  Double_t ScaleFactor_CuPetals_Co60 = Act_CuPetals_Co60*AccptRunTime/Denom_CuPetals_Co60;
  addChannelToStacks_ExtEG("CuPetals_Co60", ScaleFactor_CuPetals_Co60, FillColor_CuPetals_Co60, ExtStackColl_ExtEG, infile_ExtEG);

  // 14) CuTower_Co60
  Double_t ScaleFactor_CuTower_Co60 = Act_CuTower_Co60*AccptRunTime/Denom_CuTower_Co60;
  addChannelToStacks_ExtEG("CuTower_Co60", ScaleFactor_CuTower_Co60, FillColor_CuTower_Co60, ExtStackColl_ExtEG, infile_ExtEG);

  // 15) ScintInn_K40
  Double_t ScaleFactor_ScintInn_K40 = Act_ScintInn_K40*AccptRunTime/Denom_ScintInn_K40;
  addChannelToStacks_ExtEG("ScintInn_K40", ScaleFactor_ScintInn_K40, FillColor_ScintInn_K40, ExtStackColl_ExtEG, infile_ExtEG);

  // 16) ScintOut_K40
  Double_t ScaleFactor_ScintOut_K40 = Act_ScintOut_K40*AccptRunTime/Denom_ScintOut_K40;
  addChannelToStacks_ExtEG("ScintOut_K40", ScaleFactor_ScintOut_K40, FillColor_ScintOut_K40, ExtStackColl_ExtEG, infile_ExtEG);

  // 17) ScintPet_K40
  Double_t ScaleFactor_ScintPet_K40 = Act_ScintPet_K40*AccptRunTime/Denom_ScintPet_K40;
  addChannelToStacks_ExtEG("ScintPet_K40", ScaleFactor_ScintPet_K40, FillColor_ScintPet_K40, ExtStackColl_ExtEG, infile_ExtEG);

  // 18) SScin_Pa234m
  Double_t ScaleFactor_SScin_Pa234m = Act_SScin_Pa234m*AccptRunTime/Denom_SScin_Pa234m;
  addChannelToStacks_ExtEG("SScin_Pa234m", ScaleFactor_SScin_Pa234m, FillColor_SScin_Pa234m, ExtStackColl_ExtEG, infile_ExtEG);

  // 19) MuMetal_g1000
  Double_t ScaleFactor_MuMetal_g1000_P1 = Act_MuMetal_g1000_P1*AccptRunTime/Denom_MuMetal_g1000;
  addChannelToStacks_ExtEG("MuMetal_g1000_P1", ScaleFactor_MuMetal_g1000_P1, FillColor_MuMetal_g1000, ExtStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_MuMetal_g1000_P2 = Act_MuMetal_g1000_P2*AccptRunTime/Denom_MuMetal_g1000;
  addChannelToStacks_ExtEG("MuMetal_g1000_P2", ScaleFactor_MuMetal_g1000_P2, FillColor_MuMetal_g1000, ExtStackColl_ExtEG, infile_ExtEG);

  // 20) Neutrons
  Double_t ScaleFactor_Neutrons_P1 = Act_Neutrons_P1*AccptRunTime/Denom_Neutrons;
  addChannelToStacks_ExtEG("Data_Neutrons_P1", ScaleFactor_Neutrons_P1, FillColor_Neutrons, ExtStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_Neutrons_P2 = Act_Neutrons_P2*AccptRunTime/Denom_Neutrons;
  addChannelToStacks_ExtEG("Data_Neutrons_P2", ScaleFactor_Neutrons_P2, FillColor_Neutrons, ExtStackColl_ExtEG, infile_ExtEG);
  ...
  // Create collection of histogram stacks
  RadStackColl_ExtEG[0] = new THStack("h_ExtEG_P1_Inner","Electron Energy");
  RadStackColl_ExtEG[1] = new THStack("h_ExtEG_P1_Outer","Electron Energy");
  RadStackColl_ExtEG[2] = new THStack("h_ExtEG_P1_Petal","Electron Energy");
  RadStackColl_ExtEG[3] = new THStack("h_ExtEG_P2_Inner","Electron Energy");
  RadStackColl_ExtEG[4] = new THStack("h_ExtEG_P2_Outer","Electron Energy");
  RadStackColl_ExtEG[5] = new THStack("h_ExtEG_P2_Petal","Electron Energy");

  //  Add Radon Backgrounds

  // 0) SWire_Bi214
  Double_t Scale_SWire_Bi214_P1 = Act_SWire_Bi214_P1*AccptRunTime/Denom_SWire_Bi214;
  addChannelToStacks_ExtEG("SWire_Bi214_P1", Scale_SWire_Bi214_P1, FillColor_SWire_Bi214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t Scale_SWire_Bi214_P2 = Act_SWire_Bi214_P2*AccptRunTime/Denom_SWire_Bi214;
  addChannelToStacks_ExtEG("SWire_Bi214_P2", Scale_SWire_Bi214_P2, FillColor_SWire_Bi214, RadStackColl_ExtEG, infile_ExtEG);

  // 1) SWire_Pb214
  Double_t Scale_SWire_Pb214_P1 = Act_SWire_Pb214_P1*AccptRunTime/Denom_SWire_Pb214;
  addChannelToStacks_ExtEG("SWire_Pb214_P1", Scale_SWire_Pb214_P1, FillColor_SWire_Pb214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t Scale_SWire_Pb214_P2 = Act_SWire_Pb214_P2*AccptRunTime/Denom_SWire_Pb214;
  addChannelToStacks_ExtEG("SWire_Pb214_P2", Scale_SWire_Pb214_P2, FillColor_SWire_Pb214, RadStackColl_ExtEG, infile_ExtEG);

  // 2) SWire_Bi210 
  Double_t Scale_SWire_Bi210 = Act_SWire_Bi210*AccptRunTime/Denom_SWire_Bi210;
  addChannelToStacks_ExtEG("SWire_Bi210_P1", Scale_SWire_Bi210, FillColor_SWire_Bi210, RadStackColl_ExtEG, infile_ExtEG);
  addChannelToStacks_ExtEG("SWire_Bi210_P2", Scale_SWire_Bi210, FillColor_SWire_Bi210, RadStackColl_ExtEG, infile_ExtEG);

  // 3) SWire_Tl208 
  Double_t Scale_SWire_Tl208_P1 = Act_SWire_Tl208_P1*AccptRunTime/Denom_SWire_Tl208;
  addChannelToStacks_ExtEG("SWire_Tl208_P1", Scale_SWire_Tl208_P1, FillColor_SWire_Tl208, RadStackColl_ExtEG, infile_ExtEG);
  Double_t Scale_SWire_Tl208_P2 = Act_SWire_Tl208_P2*AccptRunTime/Denom_SWire_Tl208;
  addChannelToStacks_ExtEG("SWire_Tl208_P2", Scale_SWire_Tl208_P2, FillColor_SWire_Tl208, RadStackColl_ExtEG, infile_ExtEG);

  // 4) SFoil_Bi214_In
  Double_t ScaleFactor_SFoil_Bi214_In_P1 = Act_SFoil_Bi214_In_P1*AccptRunTime/Denom_SFoil_Bi214;
  addChannelToStacks_ExtEG("SFoil_Bi214_In_P1", ScaleFactor_SFoil_Bi214_In_P1, FillColor_SFoil_Bi214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_SFoil_Bi214_In_P2 = Act_SFoil_Bi214_In_P2*AccptRunTime/Denom_SFoil_Bi214;
  addChannelToStacks_ExtEG("SFoil_Bi214_In_P2", ScaleFactor_SFoil_Bi214_In_P2, FillColor_SFoil_Bi214, RadStackColl_ExtEG, infile_ExtEG);

  // 5) SFoil_Bi214_Out
  Double_t ScaleFactor_SFoil_Bi214_Out_P1 = Act_SFoil_Bi214_Out_P1*AccptRunTime/Denom_SFoil_Bi214;
  addChannelToStacks_ExtEG("SFoil_Bi214_Out_P1", ScaleFactor_SFoil_Bi214_Out_P1, FillColor_SFoil_Bi214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_SFoil_Bi214_Out_P2 = Act_SFoil_Bi214_Out_P2*AccptRunTime/Denom_SFoil_Bi214;
  addChannelToStacks_ExtEG("SFoil_Bi214_Out_P2", ScaleFactor_SFoil_Bi214_Out_P2, FillColor_SFoil_Bi214, RadStackColl_ExtEG, infile_ExtEG);

  // 6) SFoil_Pb214_In
  Double_t ScaleFactor_SFoil_Pb214_In_P1 = Act_SFoil_Pb214_In_P1*AccptRunTime/Denom_SFoil_Pb214;
  addChannelToStacks_ExtEG("SFoil_Pb214_In_P1", ScaleFactor_SFoil_Pb214_In_P1, FillColor_SFoil_Pb214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_SFoil_Pb214_In_P2 = Act_SFoil_Pb214_In_P2*AccptRunTime/Denom_SFoil_Pb214;
  addChannelToStacks_ExtEG("SFoil_Pb214_In_P2", ScaleFactor_SFoil_Pb214_In_P2, FillColor_SFoil_Pb214, RadStackColl_ExtEG, infile_ExtEG);

  // 7) SFoil_Pb214_Out
  Double_t ScaleFactor_SFoil_Pb214_Out_P1 = Act_SFoil_Pb214_Out_P1*AccptRunTime/Denom_SFoil_Pb214;
  addChannelToStacks_ExtEG("SFoil_Pb214_Out_P1", ScaleFactor_SFoil_Pb214_Out_P1, FillColor_SFoil_Pb214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_SFoil_Pb214_Out_P2 = Act_SFoil_Pb214_Out_P2*AccptRunTime/Denom_SFoil_Pb214;
  addChannelToStacks_ExtEG("SFoil_Pb214_Out_P2", ScaleFactor_SFoil_Pb214_Out_P2, FillColor_SFoil_Pb214, RadStackColl_ExtEG, infile_ExtEG);

  // 8) SFoil_SeNew_Bi210 
  Double_t ScaleFactor_SFoil_SeNew_Bi210 = Act_SFoil_SeNew_Bi210*AccptRunTime/Denom_SFoil_Bi210;
  addChannelToStacks_ExtEG("SFoil_SeNew_Bi210_P1", ScaleFactor_SFoil_SeNew_Bi210, FillColor_SFoil_Bi210, RadStackColl_ExtEG, infile_ExtEG);
  addChannelToStacks_ExtEG("SFoil_SeNew_Bi210_P2", ScaleFactor_SFoil_SeNew_Bi210, FillColor_SFoil_Bi210, RadStackColl_ExtEG, infile_ExtEG);

  // 9) SFoil_SeOld_Bi210 
  Double_t ScaleFactor_SFoil_SeOld_Bi210 = Act_SFoil_SeOld_Bi210*AccptRunTime/Denom_SFoil_Bi210;
  addChannelToStacks_ExtEG("SFoil_SeOld_Bi210_P1", ScaleFactor_SFoil_SeOld_Bi210, FillColor_SFoil_Bi210, RadStackColl_ExtEG, infile_ExtEG);
  addChannelToStacks_ExtEG("SFoil_SeOld_Bi210_P2", ScaleFactor_SFoil_SeOld_Bi210, FillColor_SFoil_Bi210, RadStackColl_ExtEG, infile_ExtEG);
  ...
  addChannelToStacks_ExtEG("SFoil_Strip_Bi210_P1", ScaleFactor_SFoil_Strip_Bi210, FillColor_SFoil_Bi210, RadStackColl_ExtEG, infile_ExtEG);
  addChannelToStacks_ExtEG("SFoil_Strip_Bi210_P2", ScaleFactor_SFoil_Strip_Bi210, FillColor_SFoil_Bi210, RadStackColl_ExtEG, infile_ExtEG);

  // 11) SScin_Bi214
  Double_t ScaleFactor_SScin_Bi214_P1 = Act_SScin_Bi214_P1*AccptRunTime/Denom_SScin_Bi214;
  addChannelToStacks_ExtEG("SScin_Bi214_P1", ScaleFactor_SScin_Bi214_P1, FillColor_SScin_Bi214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_SScin_Bi214_P2 = Act_SScin_Bi214_P2*AccptRunTime/Denom_SScin_Bi214;
  addChannelToStacks_ExtEG("SScin_Bi214_P2", ScaleFactor_SScin_Bi214_P2, FillColor_SScin_Bi214, RadStackColl_ExtEG, infile_ExtEG);

  // 12) SScin_Pb214
  Double_t ScaleFactor_SScin_Pb214_P1 = Act_SScin_Pb214_P1*AccptRunTime/Denom_SScin_Pb214;
  addChannelToStacks_ExtEG("SScin_Pb214_P1", ScaleFactor_SScin_Pb214_P1, FillColor_SScin_Pb214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_SScin_Pb214_P2 = Act_SScin_Pb214_P2*AccptRunTime/Denom_SScin_Pb214;
  addChannelToStacks_ExtEG("SScin_Pb214_P2", ScaleFactor_SScin_Pb214_P2, FillColor_SScin_Pb214, RadStackColl_ExtEG, infile_ExtEG);

  // 13) SScin_Bi210
  Double_t ScaleFactor_SScin_Bi210 = Act_SScin_Bi210*AccptRunTime/Denom_SScin_Bi210;
  addChannelToStacks_ExtEG("SScin_Bi210_P1", ScaleFactor_SScin_Bi210, FillColor_SScin_Bi210, RadStackColl_ExtEG, infile_ExtEG);
  addChannelToStacks_ExtEG("SScin_Bi210_P2", ScaleFactor_SScin_Bi210, FillColor_SScin_Bi210, RadStackColl_ExtEG, infile_ExtEG);

  // 14) Air_Bi214
  Double_t ScaleFactor_Air_Bi214_P1 = Act_Air_Bi214_P1*AccptRunTime/Denom_Air_Bi214;
  addChannelToStacks_ExtEG("Air_Bi214_P1", ScaleFactor_Air_Bi214_P1, FillColor_Air_Bi214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_Air_Bi214_P2 = Act_Air_Bi214_P2*AccptRunTime/Denom_Air_Bi214;
  addChannelToStacks_ExtEG("Air_Bi214_P2", ScaleFactor_Air_Bi214_P2, FillColor_Air_Bi214, RadStackColl_ExtEG, infile_ExtEG);

  // 15) Air_Pb214
  Double_t ScaleFactor_Air_Pb214_P1 = Act_Air_Pb214_P1*AccptRunTime/Denom_Air_Pb214;
  addChannelToStacks_ExtEG("Air_Pb214_P1", ScaleFactor_Air_Pb214_P1, FillColor_Air_Pb214, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_Air_Pb214_P2 = Act_Air_Pb214_P2*AccptRunTime/Denom_Air_Pb214;
  addChannelToStacks_ExtEG("Air_Pb214_P2", ScaleFactor_Air_Pb214_P2, FillColor_Air_Pb214, RadStackColl_ExtEG, infile_ExtEG);

  // 16) Air_Tl208
  Double_t ScaleFactor_Air_Tl208_P1 = Act_Air_Tl208_P1*AccptRunTime/Denom_Air_Tl208;
  addChannelToStacks_ExtEG("Air_Tl208_P1", ScaleFactor_Air_Tl208_P1, FillColor_Air_Tl208, RadStackColl_ExtEG, infile_ExtEG);
  Double_t ScaleFactor_Air_Tl208_P2 = Act_Air_Tl208_P2*AccptRunTime/Denom_Air_Tl208;
  addChannelToStacks_ExtEG("Air_Tl208_P2", ScaleFactor_Air_Tl208_P2, FillColor_Air_Tl208, RadStackColl_ExtEG, infile_ExtEG);
  ...
  // Create collection of histogram stacks
  IntStackColl_ExtEG[0] = new THStack("h_ExtEG_P1_Inner","Electron Energy");
  IntStackColl_ExtEG[1] = new THStack("h_ExtEG_P1_Outer","Electron Energy");
  IntStackColl_ExtEG[2] = new THStack("h_ExtEG_P1_Petal","Electron Energy");
  IntStackColl_ExtEG[3] = new THStack("h_ExtEG_P2_Inner","Electron Energy");
  IntStackColl_ExtEG[4] = new THStack("h_ExtEG_P2_Outer","Electron Energy");
  IntStackColl_ExtEG[5] = new THStack("h_ExtEG_P2_Petal","Electron Energy");

  // Add Internal Backgrounds

  // 0) SeNew_Bi214
  Double_t ScaleFactor_SeNew_Bi214 = Act_SeNew_Bi214*AccptRunTime/Denom_SeNew_Bi214;
  addChannelToStacks_ExtEG("SeNew_Bi214", ScaleFactor_SeNew_Bi214, FillColor_SeNew_Bi214, IntStackColl_ExtEG, infile_ExtEG);

  // 1) SeOld_Bi214
  Double_t ScaleFactor_SeOld_Bi214 = Act_SeOld_Bi214*AccptRunTime/Denom_SeOld_Bi214;
  addChannelToStacks_ExtEG("SeOld_Bi214", ScaleFactor_SeOld_Bi214, FillColor_SeOld_Bi214, IntStackColl_ExtEG, infile_ExtEG);

  // 2) Mylar_Bi214
  Double_t ScaleFactor_Mylar_Bi214 = Act_Mylar_Bi214*AccptRunTime/Denom_Mylar_Bi214;
  addChannelToStacks_ExtEG("Mylar_Bi214", ScaleFactor_Mylar_Bi214, FillColor_Mylar_Bi214, IntStackColl_ExtEG, infile_ExtEG);

  // 3) SeNew_Pb214
  Double_t ScaleFactor_SeNew_Pb214 = Act_SeNew_Pb214*AccptRunTime/Denom_SeNew_Pb214;
  addChannelToStacks_ExtEG("SeNew_Pb214", ScaleFactor_SeNew_Pb214, FillColor_SeNew_Pb214, IntStackColl_ExtEG, infile_ExtEG);

  // 4) SeOld_Pb214
  Double_t ScaleFactor_SeOld_Pb214 = Act_SeOld_Pb214*AccptRunTime/Denom_SeOld_Pb214;
  addChannelToStacks_ExtEG("SeOld_Pb214", ScaleFactor_SeOld_Pb214, FillColor_SeOld_Pb214, IntStackColl_ExtEG, infile_ExtEG);

  // 5) Mylar_Pb214
  Double_t ScaleFactor_Mylar_Pb214 = Act_Mylar_Pb214*AccptRunTime/Denom_Mylar_Pb214;
  addChannelToStacks_ExtEG("Mylar_Pb214", ScaleFactor_Mylar_Pb214, FillColor_Mylar_Pb214, IntStackColl_ExtEG, infile_ExtEG);

  // 6) SeNew_Tl208
  Double_t ScaleFactor_SeNew_Tl208 = Act_SeNew_Tl208*AccptRunTime/Denom_SeNew_Tl208;
  addChannelToStacks_ExtEG("SeNew_Tl208", ScaleFactor_SeNew_Tl208, FillColor_SeNew_Tl208, IntStackColl_ExtEG, infile_ExtEG);

  // 7) SeOld_Tl208
  Double_t ScaleFactor_SeOld_Tl208 = Act_SeOld_Tl208*AccptRunTime/Denom_SeOld_Tl208;
  addChannelToStacks_ExtEG("SeOld_Tl208", ScaleFactor_SeOld_Tl208, FillColor_SeOld_Tl208, IntStackColl_ExtEG, infile_ExtEG);

  // 8) SeNew_Bi212
  Double_t ScaleFactor_SeNew_Bi212 = Act_SeNew_Bi212*AccptRunTime/Denom_SeNew_Bi212;
  addChannelToStacks_ExtEG("SeNew_Bi212", ScaleFactor_SeNew_Bi212, FillColor_SeNew_Bi212, IntStackColl_ExtEG, infile_ExtEG);

  // 9) SeOld_Bi212
  Double_t ScaleFactor_SeOld_Bi212 = Act_SeOld_Bi212*AccptRunTime/Denom_SeOld_Bi212;
  addChannelToStacks_ExtEG("SeOld_Bi212", ScaleFactor_SeOld_Bi212, FillColor_SeOld_Bi212, IntStackColl_ExtEG, infile_ExtEG);

  // 10) SeNew_Ac228
  Double_t ScaleFactor_SeNew_Ac228 = Act_SeNew_Ac228*AccptRunTime/Denom_SeNew_Ac228;
  addChannelToStacks_ExtEG("SeNew_Ac228", ScaleFactor_SeNew_Ac228, FillColor_SeNew_Ac228, IntStackColl_ExtEG, infile_ExtEG);

  // 11) SeOld_Ac228
  Double_t ScaleFactor_SeOld_Ac228 = Act_SeOld_Ac228*AccptRunTime/Denom_SeOld_Ac228;
  addChannelToStacks_ExtEG("SeOld_Ac228", ScaleFactor_SeOld_Ac228, FillColor_SeOld_Ac228, IntStackColl_ExtEG, infile_ExtEG);

  // 12) SeNew_Pa234m
  Double_t ScaleFactor_SeNew_Pa234m = Act_SeNew_Pa234m*AccptRunTime/Denom_SeNew_Pa234m;
  addChannelToStacks_ExtEG("SeNew_Pa234m", ScaleFactor_SeNew_Pa234m, FillColor_SeNew_Pa234m, IntStackColl_ExtEG, infile_ExtEG);

  // 13) SeOld_Pa234m
  Double_t ScaleFactor_SeOld_Pa234m = Act_SeOld_Pa234m*AccptRunTime/Denom_SeOld_Pa234m;
  addChannelToStacks_ExtEG("SeOld_Pa234m", ScaleFactor_SeOld_Pa234m, FillColor_SeOld_Pa234m, IntStackColl_ExtEG, infile_ExtEG);

  // 14) SeNew_K40
  Double_t ScaleFactor_SeNew_K40 = Act_SeNew_K40*AccptRunTime/Denom_SeNew_K40;
  addChannelToStacks_ExtEG("SeNew_K40", ScaleFactor_SeNew_K40, FillColor_SeNew_K40, IntStackColl_ExtEG, infile_ExtEG);

  // 15) SeOld_K40
  Double_t ScaleFactor_SeOld_K40 = Act_SeOld_K40*AccptRunTime/Denom_SeOld_K40;
  addChannelToStacks_ExtEG("SeOld_K40", ScaleFactor_SeOld_K40, FillColor_SeOld_K40, IntStackColl_ExtEG, infile_ExtEG);
  ...
  // Create collection of histogram stacks
  SigStackColl_ExtEG[0] = new THStack("h_ExtEG_P1_SeOld","Electron Energy");
  SigStackColl_ExtEG[1] = new THStack("h_ExtEG_P1_SeNew","Electron Energy");
  SigStackColl_ExtEG[2] = new THStack("h_ExtEG_P1_Strip","Electron Energy");
  SigStackColl_ExtEG[3] = new THStack("h_ExtEG_P2_SeOld","Electron Energy");
  SigStackColl_ExtEG[4] = new THStack("h_ExtEG_P2_SeNew","Electron Energy");
  SigStackColl_ExtEG[5] = new THStack("h_ExtEG_P2_Strip","Electron Energy");

  // 0) 2b2n - SeNew
  Double_t ScaleFactor_2b2n_SeNew = Act_2b2n_SeNew*AccptRunTime/Denom_2b2n_SeNew;
  addChannelToStacks_ExtEG("2b2n_SeNew", ScaleFactor_2b2n_SeNew, FillColor_2b2n, SigStackColl_ExtEG, infile_ExtEG);

  // 1) 2b2n - SeOld
  Double_t ScaleFactor_2b2n_SeOld = Act_2b2n_SeOld*AccptRunTime/Denom_2b2n_SeOld;
  addChannelToStacks_ExtEG("2b2n_SeOld", ScaleFactor_2b2n_SeOld, FillColor_2b2n, SigStackColl_ExtEG, infile_ExtEG);
  ...
  StackColl_ExtEG[0] = new THStack("h_ExtEG_P1_Inner","Electron Energy");
  StackColl_ExtEG[1] = new THStack("h_ExtEG_P1_Outer","Electron Energy");
  StackColl_ExtEG[2] = new THStack("h_ExtEG_P1_Petal","Electron Energy");
  StackColl_ExtEG[3] = new THStack("h_ExtEG_P2_Inner","Electron Energy");
  StackColl_ExtEG[4] = new THStack("h_ExtEG_P2_Outer","Electron Energy");
  StackColl_ExtEG[5] = new THStack("h_ExtEG_P2_Petal","Electron Energy");

  // 0) Start by adding small contributors
  for(int j = 0; j < 6; j++){

    // 1e1a Backgrounds
    TH1D* h1 = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(1)->Clone("hSWire");
    TH1D* hSFoil_1e1a = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(7)->Clone("hSFoil");
    hSFoil_1e1a->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(3), -1);
    TH1D* hInternals_1e1a = (TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(5)->Clone("hInternals");
    h1->Add(hInternals_1e1a);
    h1->Add(hSFoil_1e1a);

    // 1e2g samples
    TH1D* hSWire_1e2g = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(3)->Clone("hSWire");
    hSWire_1e2g->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(2), -1);
    TH1D* hInternals_1e2g = (TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(11)->Clone("hInternals");
    hInternals_1e2g->Add((TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(5), -1);
    h1->Add(hSWire_1e2g);
    h1->Add(hInternals_1e2g);

    // Bi210 SFoil SeNew
    TH1D* hSFoil_SeNew = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(8)->Clone("hSFoil");
    hSFoil_SeNew->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(7), -1);
    h1->Add(hSFoil_SeNew);

    // Bi210 SFoil SeOld
    TH1D* hSFoil_SeOld = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(9)->Clone("hSFoil");
    hSFoil_SeOld->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(8), -1);
    h1->Add(hSFoil_SeOld);

    // Bi210 SFoil Strip
    TH1D* hSFoil_Strip = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(10)->Clone("hSFoil");
    hSFoil_Strip->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(9), -1);
    h1->Add(hSFoil_Strip);

    // Pa234m - SeNew
    TH1D* hPa234m_SeNew = (TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(12)->Clone("hPa234m");
    hPa234m_SeNew->Add((TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(11), -1);
    h1->Add(hPa234m_SeNew);

    // Pa234m - SeOld
    TH1D* hPa234m_SeOld = (TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(13)->Clone("hPa234m");
    hPa234m_SeOld->Add((TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(12), -1);
    h1->Add(hPa234m_SeOld);

    // K40 - SeNew
    TH1D* hK40_SeNew = (TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(14)->Clone("hK40");
    hK40_SeNew->Add((TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(13), -1);
    h1->Add(hK40_SeNew);

    // K40 - SeOld
    TH1D* hK40_SeOld = (TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(15)->Clone("hK40");
    hK40_SeOld->Add((TH1D*)IntStackColl_ExtEG[j]->GetStack()->At(14), -1);
    h1->Add(hK40_SeOld);

    // 2b2n
    TH1D* h2b2n = (TH1D*)SigStackColl_ExtEG[j]->GetStack()->Last()->Clone("h2b2n");
    h1->Add(h2b2n);

    h1->SetFillColor(kGray);
    StackColl_ExtEG[j]->Add(h1);

  }

  // 1) K40 PMT
  for(int j = 0; j < 6; j++){
    TH1D* hK40 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(0)->Clone("hK40");
    hK40->SetFillColor(kSpring-6);
    StackColl_ExtEG[j]->Add(hK40);
  }

  // 2) K40 Steel Frame
  for(int j = 0; j < 6; j++){
    TH1D* hK40 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(8)->Clone("hK40");
    hK40->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(7),-1);
  ...
  // 3) K40 Scint Inner
  for(int j = 0; j < 6; j++){
    TH1D* hK40 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(15)->Clone("hK40");
    hK40->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(14),-1);
  ...
  // 4) K40 Scint Outer
  for(int j = 0; j < 6; j++){
    TH1D* hK40 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(16)->Clone("hK40");
    hK40->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(15),-1);
    hK40->SetFillColor(kSpring-3);
    StackColl_ExtEG[j]->Add(hK40);
  }
  ...
  // 5) K40 Scint Petals
  for(int j = 0; j < 6; j++){
    TH1D* hK40 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(17)->Clone("hK40");
    hK40->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(16),-1);
    hK40->SetFillColor(kSpring-3);
    StackColl_ExtEG[j]->Add(hK40);
  }
  ...
  // 6) Bi214 PMT
  for(int j = 0; j < 6; j++){
    TH1D* hBi214 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(1)->Clone("hBi214");
    hBi214->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(0),-1);
    hBi214->SetFillColor(kRed);
    StackColl_ExtEG[j]->Add(hBi214);
  }

  // 7) Bi214 FeShield
  for(int j = 0; j < 6; j++){
    TH1D* hBi214 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(4)->Clone("hBi214");
    hBi214->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(3),-1);
  ...
  // 8) Bi214 SteelFrame
  for(int j = 0; j < 6; j++){
    TH1D* hBi214 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(9)->Clone("hBi214");
    hBi214->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(8),-1);
  ...
  // 9) Bi214 SScin
  for(int j = 0; j < 6; j++){
    TH1D* hSScin = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(12)->Clone("hSScin");
    hSScin->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(10), -1);
    hSScin->SetFillColor(kRed+2);
    StackColl_ExtEG[j]->Add(hSScin);
  }

  // 10)  Bi214 LSM Air
  for(int j = 0; j < 6; j++){
    TH1D* hAir = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(15)->Clone("hAir");
    hAir->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(13), -1);
    hAir->SetFillColor(kPink-1);
    StackColl_ExtEG[j]->Add(hAir);
  }

  // 11) Tl208 & Ac228 PMT
  for(int j = 0; j < 6; j++){
    TH1D* hTl208 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(3)->Clone("hTl208");
    hTl208->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(1),-1);
    hTl208->SetFillColor(kAzure);
    StackColl_ExtEG[j]->Add(hTl208);
  }

  // 12) Tl208 & Ac228 FeShield
  for(int j = 0; j < 6; j++){
    TH1D* hTl208 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(6)->Clone("hTl208");
    hTl208->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(4),-1);
  ...
  for(int j = 0; j < 6; j++){
    TH1D* hTl208 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(11)->Clone("hTl208");
    hTl208->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(9),-1);
  ...
  // 14) Tl208 LSM Air
  for(int j = 0; j < 6; j++){
    TH1D* hTl208 = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(16)->Clone("hTl208");
    hTl208->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(15),-1);
  ...
  // 15) Co60 MuMetal
  for(int j = 0; j < 6; j++){
    TH1D* hCo60 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(7)->Clone("hCo60");
    hCo60->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(6),-1);
    hCo60->SetFillColor(kTeal+9);
    StackColl_ExtEG[j]->Add(hCo60);
  }

  // 16) Co60 SteelFrame
  for(int j = 0; j < 6; j++){
    TH1D* hCo60 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(12)->Clone("hCo60");
    hCo60->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(11),-1);
  ...
  // 17) Co60 CuPetals
  for(int j = 0; j < 6; j++){
    TH1D* hCo60 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(13)->Clone("hCo60");
    hCo60->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(12),-1);
  ...
  // 18) Co60 CuTower
  for(int j = 0; j < 6; j++){
    TH1D* hCo60 = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(14)->Clone("hCo60");
    hCo60->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(13),-1);
  ...
  // 19) Bi210 SScin
  for(int j = 0; j < 6; j++){
    TH1D* hSScin = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(13)->Clone("hSScin");
    hSScin->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(12), -1);
  ...
  // 20) SWire-B210
  for(int j = 0; j < 6; j++){
    TH1D* hSWire = (TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(2)->Clone("hSWire");
    hSWire->Add((TH1D*)RadStackColl_ExtEG[j]->GetStack()->At(1), -1);
    hSWire->SetFillColor(kOrange);
    StackColl_ExtEG[j]->Add(hSWire);
  }

  // 21) SScin-Pa234m
  for(int j = 0; j < 6; j++){
    TH1D* hSScin = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(18)->Clone("hSScin");
    hSScin->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(17), -1);
  ...
  // 22) MuMetal-g1000
  for(int j = 0; j < 6; j++){
    TH1D* hGFlux = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(19)->Clone("hGFlux");
    hGFlux->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(18), -1);
    hGFlux->SetFillColor(kYellow-2);
    StackColl_ExtEG[j]->Add(hGFlux);
  }

  // 23) Neutrons
  for(int j = 0; j < 6; j++){
    TH1D* hNeutrons = (TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(20)->Clone("hNeutrons");
    hNeutrons->Add((TH1D*)ExtStackColl_ExtEG[j]->GetStack()->At(19), -1);
    hNeutrons->SetFillColor(kSpring+9);
    StackColl_ExtEG[j]->Add(hNeutrons);
  }
  ...
  // Make legends
  for(int i = 0; i < 6; i++){
    Legend_ExtEG[i] = new TLegend(0.540,0.4845,0.947,0.947);
    Legend_ExtEG[i]->SetNColumns(2);
    Legend_ExtEG[i]->SetColumnSeparation(-0.05);
    Legend_ExtEG[i]->SetFillColor(0);
    Legend_ExtEG[i]->SetLineColor(0);
    Legend_ExtEG[i]->SetBorderSize(0);
    LegendLog_ExtEG[i] = new TLegend(0.7199,0.4845,0.947,0.947);
    LegendLog_ExtEG[i]->SetFillColor(0);
    LegendLog_ExtEG[i]->SetLineColor(0);
    LegendLog_ExtEG[i]->SetBorderSize(0);
  }

  char Num_Events[40];

  sprintf (Num_Events, "%d Events", (int) h_ExtEG_Data_P1_Inner->GetEntries());
  Legend_ExtEG[0]->AddEntry(h_ExtEG_Data_P1_Inner, "Data", "lpe");
  Legend_ExtEG[0]->AddEntry(h_ExtEG_Data_P1_Inner, Num_Events, "");
  LegendLog_ExtEG[0]->AddEntry(h_ExtEG_Data_P1_Inner, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_ExtEG_Data_P1_Outer->GetEntries());
  Legend_ExtEG[1]->AddEntry(h_ExtEG_Data_P1_Outer, "Data", "lpe");
  Legend_ExtEG[1]->AddEntry(h_ExtEG_Data_P1_Outer, Num_Events, "");
  LegendLog_ExtEG[1]->AddEntry(h_ExtEG_Data_P1_Outer, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_ExtEG_Data_P1_Petal->GetEntries());
  Legend_ExtEG[2]->AddEntry(h_ExtEG_Data_P1_Petal, "Data", "lpe");
  Legend_ExtEG[2]->AddEntry(h_ExtEG_Data_P1_Petal, Num_Events, "");
  LegendLog_ExtEG[2]->AddEntry(h_ExtEG_Data_P1_Petal, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_ExtEG_Data_P2_Inner->GetEntries());
  Legend_ExtEG[3]->AddEntry(h_ExtEG_Data_P2_Inner, "Data", "lpe");
  Legend_ExtEG[3]->AddEntry(h_ExtEG_Data_P2_Inner, Num_Events, "");
  LegendLog_ExtEG[3]->AddEntry(h_ExtEG_Data_P2_Inner, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_ExtEG_Data_P2_Outer->GetEntries());
  Legend_ExtEG[4]->AddEntry(h_ExtEG_Data_P2_Outer, "Data", "lpe");
  Legend_ExtEG[4]->AddEntry(h_ExtEG_Data_P2_Outer, Num_Events, "");
  LegendLog_ExtEG[4]->AddEntry(h_ExtEG_Data_P2_Outer, "Data", "lpe");

  sprintf (Num_Events, "%d Events", (int) h_ExtEG_Data_P2_Petal->GetEntries());
  Legend_ExtEG[5]->AddEntry(h_ExtEG_Data_P2_Petal, "Data", "lpe");
  Legend_ExtEG[5]->AddEntry(h_ExtEG_Data_P2_Petal, Num_Events, "");
  LegendLog_ExtEG[5]->AddEntry(h_ExtEG_Data_P2_Petal, "Data", "lpe");

  for(int j = 0; j < 6; j++){

    if(j < 3){
      TH1 *h;
      TIter   next(StackColl_ExtEG[j]->GetHists());
      for(int i = 0; i < 24; i++){
	h = (TH1*) next();
	Legend_ExtEG[j]->AddEntry(h, LegIsotopes_P1[i].c_str(), "f");
	Legend_ExtEG[j]->AddEntry(h, LegEntries_P1[i].c_str(), "");
	LegendLog_ExtEG[j]->AddEntry(h, LegIsotopes_P1[i].c_str(), "f");
      }
    } else{
      TH1 *h;
      TIter   next(StackColl_ExtEG[j]->GetHists());
      for(int i = 0; i < 24; i++){
	h = (TH1*) next();
	Legend_ExtEG[j]->AddEntry(h, LegIsotopes_P2[i].c_str(), "f");
	Legend_ExtEG[j]->AddEntry(h, LegEntries_P2[i].c_str(), "");
	LegendLog_ExtEG[j]->AddEntry(h, LegIsotopes_P2[i].c_str(), "f");
      }
    }
  }
  ...
  for (int i = 0; i < 6; i++){
    ChiSquares_ExtEG[i] = new TPaveText(0.587,0.435,0.762,0.475,"LNDC");
    ChiSquares_ExtEG[i]->SetFillColor(0);
    ChiSquares_ExtEG[i]->SetLineColor(0);
    ChiSquares_ExtEG[i]->SetBorderSize(0);
    ChiSquares_ExtEG[i]->SetTextAlign(12);

    ChiSquaresLog_ExtEG[i] = new TPaveText(0.737,0.427,0.921,0.467,"LNDC");
    ChiSquaresLog_ExtEG[i]->SetFillColor(0);
    ChiSquaresLog_ExtEG[i]->SetLineColor(0);
    ChiSquaresLog_ExtEG[i]->SetBorderSize(0);
    ChiSquaresLog_ExtEG[i]->SetTextAlign(12);
  }

  char ChiSquareText[100];
  pair<Double_t,Int_t> ChiSquareResult;

  ChiSquareResult = ChiSquareTest(h_ExtEG_Data_P1_Inner, (TH1D*)StackColl_ExtEG[0]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_ExtEG[0]->AddText(ChiSquareText);
  ChiSquaresLog_ExtEG[0]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_ExtEG_Data_P1_Outer, (TH1D*)StackColl_ExtEG[1]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_ExtEG[1]->AddText(ChiSquareText);
  ChiSquaresLog_ExtEG[1]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_ExtEG_Data_P1_Petal, (TH1D*)StackColl_ExtEG[2]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_ExtEG[2]->AddText(ChiSquareText);
  ChiSquaresLog_ExtEG[2]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_ExtEG_Data_P2_Inner, (TH1D*)StackColl_ExtEG[3]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_ExtEG[3]->AddText(ChiSquareText);
  ChiSquaresLog_ExtEG[3]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_ExtEG_Data_P2_Outer, (TH1D*)StackColl_ExtEG[4]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_ExtEG[4]->AddText(ChiSquareText);
  ChiSquaresLog_ExtEG[4]->AddText(ChiSquareText);

  ChiSquareResult = ChiSquareTest(h_ExtEG_Data_P2_Petal, (TH1D*)StackColl_ExtEG[5]->GetStack()->Last());
  sprintf(ChiSquareText, "#chi^{2} / ndf = %.2f / %.d", ChiSquareResult.first, ChiSquareResult.second);
  ChiSquares_ExtEG[5]->AddText(ChiSquareText);
  ChiSquaresLog_ExtEG[5]->AddText(ChiSquareText);
