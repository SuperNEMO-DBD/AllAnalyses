...
#ifndef NEMO_NEMORH10INPUTMODULE_H_
#define NEMO_NEMORH10INPUTMODULE_H_
...
class NemorH10InputModule : public AppNtupleInputModule {
public:
    //------------------------------------------------------------
    // Constructor and Destructor
    //------------------------------------------------------------
    NemorH10InputModule(const std::string theName = "NemorH10InputModule", 
                          const std::string theDescription = "");
    virtual ~NemorH10InputModule();
...
private:
    ...
    int     evntime_;      // cv - 7/3/13: event timestamp in NEMOR format
