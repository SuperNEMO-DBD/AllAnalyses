...
void efficiency_delta_t_test(){

  int n=9 ;

  double tab_eff_0nu[9] = {58.2,66.4,70.9,72.8,73.5,73.6,73.4,72.9,72.5} ;
  double tab_eff_Tl[9] = {100-10.8,100-13.6,100-17.8,100-20.5,100-23.2,100-24.4,100-26,100-27.5,100-29} ;
