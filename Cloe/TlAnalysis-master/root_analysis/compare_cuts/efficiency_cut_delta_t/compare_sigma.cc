...
void compare_sigma(){
  ...
  string file_data_0ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/compare_cuts/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_0.root" ;
  TFile *theDataFile_0ps = new TFile(file_data_0ps.c_str(),"READ") ;

  TGraph *gr_eff_0ps = (TGraph*)theDataFile_0ps->Get("Graph");

  string file_data_400ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/compare_cuts/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_4.root" ;
  TFile *theDataFile_400ps = new TFile(file_data_400ps.c_str(),"READ") ;

  TGraph *gr_eff_400ps = (TGraph*)theDataFile_400ps->Get("Graph");

  string file_data_300ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/compare_cuts/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_3.root" ;
  TFile *theDataFile_300ps = new TFile(file_data_300ps.c_str(),"READ") ;

  TGraph *gr_eff_300ps = (TGraph*)theDataFile_300ps->Get("Graph");

  string file_data_200ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/compare_cuts/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_2.root" ;
  TFile *theDataFile_200ps = new TFile(file_data_200ps.c_str(),"READ") ;

  TGraph *gr_eff_200ps = (TGraph*)theDataFile_200ps->Get("Graph");

  string file_data_100ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/compare_cuts/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_1.root" ;
  ...
  auto t1 = new TPaveText(0.1862464,0.8386412,0.2449857,0.8832272,"NDC");
  t1->SetBorderSize(0) ;
  t1->SetFillColor(0) ;
  ...
  auto t2 = new TPaveText(0.6647564,0.2271762,0.7234957,0.2717622,"NDC");
  t2->SetBorderSize(0) ;
  t2->SetFillColor(0) ;
  ...
  auto t3 = new TPaveText(0.3868195,0.7261146,0.4455587,0.7707006,"NDC");
  t3->SetBorderSize(0) ;
  t3->SetFillColor(0) ;
  t3->SetFillColor(0) ;
