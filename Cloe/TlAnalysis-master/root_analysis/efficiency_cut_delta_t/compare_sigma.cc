...
void compare_sigma(){
  ...
  string file_data_0ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_0.root" ;
  TFile *theDataFile_0ps = new TFile(file_data_0ps.c_str(),"READ") ;

  TGraph *gr_eff_0ps = (TGraph*)theDataFile_0ps->Get("Graph");

  string file_data_400ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_4.root" ;
  TFile *theDataFile_400ps = new TFile(file_data_400ps.c_str(),"READ") ;

  TGraph *gr_eff_400ps = (TGraph*)theDataFile_400ps->Get("Graph");

  string file_data_300ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_3.root" ;
  TFile *theDataFile_300ps = new TFile(file_data_300ps.c_str(),"READ") ;

  TGraph *gr_eff_300ps = (TGraph*)theDataFile_300ps->Get("Graph");

  string file_data_200ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_2.root" ;
  TFile *theDataFile_200ps = new TFile(file_data_200ps.c_str(),"READ") ;

  TGraph *gr_eff_200ps = (TGraph*)theDataFile_200ps->Get("Graph");

  string file_data_100ps = "/home/girardcarillo/Workdir/Analyses/TlAnalysis/root_analysis/efficiency_cut_delta_t/plots/efficiency_cut_delta_t_1.root" ;
