...
RawGeigerHit::RawGeigerHit(const RawGeigerHit &h)
{
  ...
  _layer = h._layer;
  _column = h._column;
  _asicValue = h._asicValue;
  _asicStatus = h._asicStatus;
...
void RawGeigerHit::setAddress(int m, int s, int l, int c, int asic)
{
...
void RawGeigerHit::setData(int an, int ct, int cb, int al, int stat)
{
...
std::ostream& operator<<(std::ostream &out, const RawGeigerHit &h)
{
  if (h.isValid())
  {
    out << "RawGeigerHit address:\n"
        ...
        << "layer:  " << h._layer << '\n'
        << "column: " << h._column << '\n'
        << "asic value: " << h._asicValue << '\n'
        << "asic status: " << h._asicStatus << '\n'
        << "RawGeigerHit TDCs:\n"
